...
(() => {
  ...
  function h(e, t, s, i) {
    return 1 == t
      ? Math.floor(i / e)
      : Math.floor(
          Math.log((i * (t - 1)) / (e * Math.pow(t, s)) + 1) / Math.log(t)
        );
  }
  function l(e, t, s, i) {
    return 1 == t
  ...
  function H(e) {
    if (
      ...
      e.data.originalEvent.touches && e.data.originalEvent.touches.length > 1)
    )
      !(function (e) {
        const t = Math.abs(
      ...
      ((this.x = e.x - this.dragOffset.x),
        ...
        F(this),
        s(this.dragStartX, this.dragStartY, this.x, this.y) > 5 &&
          (this.hasMoved = !0));
    }
  }
  function F(e) {
  ...
  function L(e) {
    ...
    e.deltaY < 0 || e.deltaX < 0 ? E(1, t) : E(-1, t);
  }
  function Z(e = !1) {
    (e &&
  ...
  function U(e, t) {
    (!(function (e) {
      ...
      let s = !1;
      const i = c;
      (t.w && ((i.y += t.scrollSpeed * e), (s = !0)),
        t.a && ((i.x += t.scrollSpeed * e), (s = !0)),
        t.s && ((i.y -= t.scrollSpeed * e), (s = !0)),
        t.d && ((i.x -= t.scrollSpeed * e), (s = !0)),
        s && F(i));
    })(e),
      G.update(),
      (e *= v.gameSpeed),
      ...
      (function (e, t) {
        if (
          ...
          (c.position.set(0, 0),
            ...
            c.scale.set(2, 2),
            t.renderer.render(c, y, void 0, X),
            c.scale.set(e, s),
            c.position.set(i, a));
        } else f.visible = !1;
      })(e, t));
  ...
  function Y() {
    ...
    ((D = { x: e, y: t, defaultScale: Math.max(e, t) / 1e3 }),
      (O.scrollSpeed = Math.max(e, t) / 4));
  }
  (new Map(),
          ...
          (document.body.appendChild(e.view),
            ...
            (function (e) {
              ((c = new PIXI.Container()),
                ...
                (y = PIXI.RenderTexture.create({ width: 300, height: 300 })),
                (f = new PIXI.Sprite(y)),
                (f.visible = !1),
                (f.alpha = 0),
                m.addChild(f),
  ...
  const O = { scrollSpeed: 200, w: !1, a: !1, s: !1, d: !1, shift: !1 };
  ((window.onblur = function () {
    ((O.w = O.a = O.s = O.d = !1), (O.shift = !1));
  }),
  ...
  class q {
    ...
    updateSpells(e) {
      for (let t = 0; t < this.spells.length; t++) {
        ...
        (s.onCooldown &&
          !s.active &&
          ((s.cooldownLeft -= e), s.cooldownLeft <= 0 && (s.onCooldown = !1)),
          s.active &&
            ((s.timer -= e), s.timer <= 0 && ((s.active = !1), s.end())));
      }
    }
  }
  ...
  class se {
    ...
    factoryStats() {
      ...
      return { machines: e, partsPerSec: t * this.gameModel.partsPCMod };
    }
    update(e) {
        ...
        ((this.generatorsApplied[t].timeLeft -= e),
          this.generatorsApplied[t].timeLeft <= 0 &&
            ...
            (this.gameModel.persistentData.parts +=
              this.generatorsApplied[t].total * this.gameModel.partsPCMod)));
    }
    updateLongTime(e) {
      let t = 0;
      for (let s = 0; s < this.generatorsApplied.length; s++)
  ...
  class ae {
    ...
    refundParts(e, t) {
      ...
      switch (e) {
        case this.types.earthGolem:
          s = this.purchasePrice(this.creatures[0]);
          break;
        case this.types.airGolem:
          s = this.purchasePrice(this.creatures[1]);
          break;
        case this.types.fireGolem:
          s = this.purchasePrice(this.creatures[2]);
          break;
        case this.types.waterGolem:
          s = this.purchasePrice(this.creatures[3]);
      }
      this.gameModel.persistentData.parts += s * t;
    }
    purchasePrice(e) {
      return (
        e.baseCost *
    ...
    spawnCreature(e) {
      ...
      t.spawnCreature(s, i, e.speed, e.type, e.level);
    }
    spawnSavedCreatures() {
    ...
    updatePersistentData() {
      (this.persistentData.constructions ||
        ...
        void 0 === this.persistentData.particles &&
          (this.persistentData.particles = !0),
    ...
    importFile() {
      ...
      if (e && 1 == e.length) {
        ...
        ((s.onload = function (e) {
          ...
          t.dateOfSave
            ? (t.skeleton &&
                ((i.skeleton.persistent = t.skeleton), delete t.skeleton),
              t.skeletonTalents
      ...
      if (
        ...
        (this.constructionUpgrades = [
          ...
          new he(
            ...
            { bones: 3e3, blood: 12e4, brains: 1e3 },
            30,
            1,
            1,
            1,
    ...
    applyUpgrade(e, t) {
      switch (e.type) {
        ...
        case this.types.bloodStoragePC:
          return void (this.gameModel.bloodStorePCMod *= Math.pow(
            1 + e.effect,
            t
          ));
        ...
        case this.types.brainsStoragePC:
          return void (this.gameModel.brainsStorePCMod *= Math.pow(
            1 + e.effect,
            t
          ));
    ...
    applyConstructionUpgrade(e) {
      switch (e.type) {
        ...
        case this.constructionTypes.partFactory:
          return (
            (this.gameModel.constructions.partFactory = !0),
            void (this.gameModel.constructions.factory = !0)
          );
        case this.constructionTypes.monsterFactory:
          return (
            (this.gameModel.constructions.monsterFactory = !0),
            void (this.gameModel.constructions.factory = !0)
          );
      }
    }
      ...
      switch (e.type) {
        ...
        case this.types.boneCollectorCapacity:
          return (
            ...
            n(this.gameModel.boneCollectorCapacity)
          );
        case this.types.bonesGainPC:
          return (
            "Bones: " + n(Math.round(100 * this.gameModel.bonesPCMod)) + "%"
          );
        case this.types.partsGainPC:
          return (
            "Parts: " + n(Math.round(100 * this.gameModel.partsPCMod)) + "%"
          );
        case this.types.bloodGainPC:
          return (
            "Blood: " + n(Math.round(100 * this.gameModel.bloodPCMod)) + "%"
          );
        case this.types.bloodStoragePC:
          return (
            "Blood Storage: " + n(100 * this.gameModel.bloodStorePCMod) + "%"
          );
        case this.types.brainsGainPC:
          return (
            "Brains: " + n(Math.round(100 * this.gameModel.brainsPCMod)) + "%"
          );
        case this.types.brainsStoragePC:
          return (
            "Brains Storage: " + n(100 * this.gameModel.brainsStorePCMod) + "%"
          );
        case this.types.zombieDmgPC:
          return (
            "Zombie Damage: " +
            Math.round(100 * this.gameModel.zombieDamagePCMod) +
            "%"
          );
        case this.types.zombieHealthPC:
          return (
            "Zombie Health: " +
            Math.round(100 * this.gameModel.zombieHealthPCMod) +
            "%"
          );
        case this.types.golemDamagePC:
          return (
  ...
  class de {
    ...
    getAquiredTrophyList() {
      ...
      for (let t = 0; t < this.gameModel.persistentData.trophies.length; t++)
        e.push(
          this.createTrophy(this.gameModel.persistentData.trophies[t], !0, !1)
        );
      return e;
    }
  }
  ...
  class Se {
    ...
    populate() {
      ...
      ((this.vip = void 0),
        i
          ? (this.escapeTarget = { x: P.x / 2, y: P.y + 50 })
    ...
    updateDeadHumanFading(e, t) {
      if (e.visible) {
        ...
        ((e.alpha -= this.fadeSpeed * t),
          e.alpha < 0 && ((e.visible = !1), g.removeChild(e)));
      }
    }
    changeState(e, t) {
      switch (t) {
    ...
    updatePlague(e, t) {
      ((e.timer.plagueTick -= t),
        e.timer.plagueTick < 0 &&
          ...
          (e.timer.plagueTick = this.plagueTickTimer),
          this.exclamations.newPoison(e),
          e.plagueTicks--,
          this.pandemic && this.pandemicBullet(e),
          e.plagueTicks <= 0 &&
            ((e.flags.infected = !1), (e.plagueDamage = 0))));
    }
    pandemicBullet(e) {
    ...
    updatePolice(e, t, s) {
      ...
      switch (
        ...
        case ue.standing:
          ...
          break;
        case ue.walking:
          i(e.position.x, e.position.y, e.target.x, e.target.y) <
          this.moveTargetDistance
            ? ((e.target = !1),
              (e.zombieTarget = null),
      ...
      switch (
        ...
        case ge.patrolling:
          (e.target || (e.target = this.map.randomPositionInBuilding(null)),
            i(e.position.x, e.position.y, e.target.x, e.target.y) <
            this.moveTargetDistance
              ? ((e.target = !1), (e.zombieTarget = null))
              : this.humans.updateHumanSpeed(e, t));
          break;
        case ge.attacking:
          e.attackingGraveyard
  ...
  class ze extends PIXI.Text {
    ...
    updateCritText(e) {
      this.visible &&
        ...
        this.fadeTime < 0 &&
          ((this.alpha -= 2 * e),
          this.alpha < 0 && ((this.visible = !1), Re.push(this))));
    }
    reset() {
  ...
  class Ee {
    ...
    createZombie(e, t, s = !1) {
      ...
      (this.discardedZombies.length > 0
        ...
        : (a = new Ae(s ? this.dogTexture : this.textures[i].animated)),
        (a.zombie = !0),
        (a.mod = 1),
        (a.scaleMod = 1),
        ...
        (this.graveyard.isWithinFence(e) &&
          ...
          e.health <= 0 &&
            ...
            Math.random() < this.model.infectedBlastChance &&
              this.causePlagueExplosion(e, 0.2 * e.maxHealth, !0, !1),
            (e.textures = e.deadTexture),
            e.gotoAndStop(0),
    ...
    update(e) {
      ...
      if (
        ...
        if (((this.zombieCursor.visible = !0), O.shift)) {
  ...
  class Xe {
    ...
    generateLoot(e) {
      ...
      if (
        ...
        ((s = this.rarity.rare),
        Math.random() < 0.2 * this.lootChanceMod &&
          ((s = this.rarity.epic), Math.random() < 0.1 * this.lootChanceMod))
      ) {
    ...
    destroyAllItems() {
      (this.addXp(this.xpForItems()),
        (this.persistent.items = this.persistent.items.filter(
          (e) => e.q || e.r == this.rarity.legendary
        )));
    }
    xpForItems() {
      let e = 0;
  ...
  class Ue {
    ...
    spawnCreature(e, t, s, i, a) {
      if (this.model.creatureCount >= this.model.creatureLimit) return;
      let r;
      switch (
        (this.discardedSprites.length > 0
          ? ((r = this.discardedSprites.pop()),
            (r.textures = this.golemTextures.down))
          : (r = new Pe(this.golemTextures.down)),
        i)
      ) {
        case this.creatureTypes.earthGolem:
          ((r.tint = 11042610),
            (r.bulletReflect = this.model.bulletproofChance));
          break;
        case this.creatureTypes.airGolem:
          r.tint = 10266040;
          break;
        case this.creatureTypes.fireGolem:
          ((r.tint = 14370586), (r.immuneToBurns = !0));
          break;
        case this.creatureTypes.waterGolem:
          ((r.tint = 5080808), (r.immuneToBurns = !0));
      }
      ((r.flags = new K()),
        (r.flags.golem = !0),
        (r.burnDamage = 0),
        (r.level = a),
        (r.textureSet = this.golemTextures),
        (r.deadTexture = this.golemTextures.dead),
        (r.currentDirection = this.directions.down),
        (r.creatureType = i),
        (r.lastKnownBuilding = !1),
        (r.alpha = 1),
        (r.animationSpeed = 0.15),
        r.anchor.set(8.5 / 16, 1),
        r.position.set(
          this.graveyard.sprite.x,
          this.graveyard.sprite.y + (this.graveyard.level > 2 ? 8 : 0)
        ),
        (r.target = null),
        (r.zIndex = r.position.y),
        (r.visible = !0),
        (r.maxHealth = r.health = e),
        (r.attackDamage = t),
        (r.regenTimer = 5),
        (r.state = be.lookingForTarget),
        (r.scaling = this.scaling),
        r.scale.set(r.scaling, r.scaling),
        (r.xSpeed = 0),
        (r.ySpeed = 0),
        (r.speedMultiplier = 1),
        (r.maxSpeed = s),
        (r.timer.ability = 4 * Math.random()),
        (r.timer.attack = 0),
        (r.timer.scan = 0),
        (r.timer.burnTick = this.burnTickTimer),
        (r.timer.smoke = this.smokeTimer),
        r.play(),
        (r.zombieId = this.currId++),
        this.creatures.push(r),
        g.addChild(r),
        this.smoke.newZombieSpawnCloud(r.x, r.y - 2),
  ...
  class Oe extends PIXI.AnimatedSprite {
    constructor(e) {
      (super(e),
        (this.xSpeed = 0),
        (this.ySpeed = 0),
  ...
  const St = [
      new xt(
        ...
        function () {
          const e = dt.talents[this.id];
          return e && e > 0
            ? `Golem upgrade and summoning cost reduced by ${5 * e}%`
            : "Reduces golem upgrade and summoning cost by 5%";
        }
      ),
      new xt(
        2,
        ...
        function () {
          const e = dt.talents[this.id];
          return e && e > 0
            ? `Skeleton killing blows reward ${10 * e}% of your current parts per second`
            : "Skeleton killing blows reward 10% of your current parts per second";
        }
      ),
      new xt(
        3,
      ...
      new xt(
        ...
        function () {
          const e = dt.talents[this.id];
          return e && e > 0
            ? `Spell cost reduced by ${5 * e} energy`
            : "Reduces spell cost by 5 energy";
        }
      ),
      new xt(
        7,
  ...
  function wt() {
    dt.persistent.talentReset &&
      (St.forEach((e) => e.reset()), (dt.persistent.talentReset = !1));
  }
  (St.forEach((e) => {
      ...
      .controller("ZombieController", [
        ...
        function (e, t, s) {
          ...
          function u() {
            ...
            (!(function (e, t) {
              (c.model.update(e, t), c.updateMessages(e));
          ...
          ((c.model = ne.getInstance()),
              ...
              creatureButtonText(e) {
                return e.building
                  ...
                  : this.creatureTooExpensive(e)
                    ? n(this.creaturePrice(e) - c.model.persistentData.parts) +
                      " parts required"
                    : "Build (" + n(this.creaturePrice(e)) + " parts)";
              },
            ...
            (c.upgradeSubtitle = function (e) {
              switch (e.type) {
                ...
                case h.types.zombieDmgPC:
                  return (
                    "+" + n(Math.round(100 * e.effect)) + "% zombie damage"
                  );
                case h.types.zombieHealthPC:
                  return (
                    "+" + n(Math.round(100 * e.effect)) + "% zombie health"
                  );
            ...
            (c.requiredForUpgrade = function (e) {
              ...
              switch (e.costType) {
                ...
                case r.costs.blood:
                  return (
                    n(t - c.model.persistentData.blood) + " blood required"
                  );
                case h.costs.brains:
                  return (
                    n(t - c.model.persistentData.brains) + " brains required"
                  );
                case h.costs.bones:
                  return (
                    n(t - c.model.persistentData.bones) + " bones required"
                  );
                case h.costs.prestigePoints:
                  return (
                    n(t - c.model.persistentData.prestigePointsToSpend) +
                    " prestige points required"
                  );
                case r.costs.parts:
                  return (
                    n(t - c.model.persistentData.parts) + " parts required"
                  );
              }
            }),
            ...
            (c.toggleAutoStart = function () {
              c.model.persistentData.autoStart
                ? (c.model.persistentData.autoStart = !1)
            ...
            (c.doPrestige = function () {
              confirm("Are you sure?") && c.model.prestige();
            }),
            ...
            (c.skeletonMenu = {
              ...
              trophies: () =>
                i.persistent.skeletons > 0
                  ? ` - ${c.model.persistentData.trophies.length} / ${20 * i.persistent.xpRate} Trophies`
                  : "",
