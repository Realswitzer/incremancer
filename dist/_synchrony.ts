...
((() => {
    var e = {
        ...
        floorSprite: this.getFloorSprite(),
        entrance: n,
        walls: [],
        corners: [],
        autobuild: t,
        ...
        bones: 0,
        health: t,
        target: this.map.randomPositionInBuilding(e.currentPoi),
        maxSpeed: e.timer.flee > 0 ? this.maxRunSpeed : this.maxWalkSpeed,
        xSpeed: 0,
        ySpeed: 0,
        deadTexture: this.doctorDeadTexture,
        deadTexture: this.textures[s].dead,
        burnDamage: 0,
        plagueDamage: 0,
        plagueTicks: 0,
        animationSpeed: 0.15,
        currentPoi: this.map.getRandomBuilding(),
        zIndex: e.position.y,
        xSpeed: 0,
        ySpeed: 0,
        target: false,
        ...
        visible: true,
        alpha: 1,
        maxHealth: e.health = s,
        xSpeed: e.targetVector.x * s,
        ySpeed: e.targetVector.y * s,
        zIndex: e.position.y,
        alpha: this.fadeSpeed * t,
        state: t,
        health: 2 * this.attackDamage,
        health: e.maxHealth,
        speedMod: Math.max(Math.min(1, e.health / e.maxHealth), 0.25),
        burnDamage: 0,
        plagueDamage: 0,
        plagueTicks: 0,
        deadTexture: this.deadTexture,
        animationSpeed: 0.2,
        currentPoi: this.map.getRandomBuilding(),
        zIndex: e.position.y,
        xSpeed: 0,
        ...
        radioTime: 5,
        speedMod: 1,
        lastKnownBuilding: void 0,
        maxSpeed: this.maxWalkSpeed,
        visionDistance: this.visionDistance,
        visible: true,
        maxHealth: e.health = t,
        target: false,
        zombieTarget: void 0,
        policeState: ue.standing,
        target: e.zombieTarget,
        policeState: t,
        policeState: ue.hunting,
        policeState: ue.attacking,
        target: e.owner.zombieTarget,
        burnDamage: 0,
        plagueDamage: 0,
        minigun: 1 == s,
        rocketlauncher: 2 == s,
        ...
        target: false,
        zombieTarget: null,
        graveYardTarget: null,
        armyState: pe.standing,
        attackingGraveyard: false,
        target: null !== (t = e.graveYardTarget) && void 0 !== t ? t : e.zombieTarget,
        armyState: t,
        turretSprite: new PIXI.Sprite(this.textures.turret),
        animationSpeed: 0.2,
        x: 0,
        y: 0,
        currentDirection: me.horizontal,
        currentPoi: this.map.getRandomBuilding(),
        zIndex: e.position.y,
        xSpeed: 0,
        ySpeed: 0,
        ...
        graveYardTarget: null,
        attackingGraveyard: false,
        tankState: ge.patrolling,
        target: null !== (s = e.graveYardTarget) && void 0 !== s ? s : e.zombieTarget,
        tankState: t,
        alpha: 0.6,
        health: t * this.model.runeEffects.damageReduction,
        state: be.attackingTarget,
        regenTimer: t,
        health: t,
        target: this.graveyardAttackers[s],
        target: this.aliveHumans[s],
        target: a(this.aliveHumans, Math.random()),
        xSpeed: e.targetVector.x * s,
        ySpeed: e.targetVector.y * s,
        xSpeed: e.targetVector.x * s,
        ySpeed: e.targetVector.y * s,
        ...
        bulletReflect: 0,
        zombie: true,
        textureSet: this.textures,
        deadTexture: this.textures.dead,
        currentDirection: this.directions.down,
        flags: new K(),
        burnDamage: 0,
        lastKnownBuilding: false,
        alpha: 1,
        animationSpeed: 0.15,
        target: null,
        zIndex: e.position.y,
        visible: true,
        maxHealth: e.health = 10 * this.model.zombieHealth,
        attackDamage: 10 * this.model.zombieDamage,
        regenTimer: 5,
        state: be.lookingForTarget,
        scaling: this.scaling,
        xSpeed: 0,
        ySpeed: 0,
        speedMultiplier: 1,
        maxSpeed: this.moveSpeed,
        zombieId: this.currId++,
        state: be.attackingTarget,
        state: be.movingToTarget,
        currentDirection: t,
        xSpeed: e.targetVector.x * i,
        ySpeed: e.targetVector.y * i,
        zIndex: e.position.y,
        state: be.attackingTarget,
        currentDirection: t,
        xSpeed: e.targetVector.x * s,
        ...
        state: We.collecting,
        boneList: [],
        speedFactor: Math.min(1, e.speedFactor += 3 * t),
        xSpeed: s * n * this.maxSpeed * e.speedFactor,
        ySpeed: i * n * this.maxSpeed * e.speedFactor,
        zIndex: e.position.y,
        target: false,
        zIndex: e.position.y,
        state: qe.returning,
        target: a(this.tanks.aliveTanks, Math.random()),
        bomb: t,
        speedFactor: Math.min(1, e.speedFactor += 2 * t),
        xSpeed: s * n * this.model.harpySpeed * e.speedFactor,
        ySpeed: i * n * this.model.harpySpeed * e.speedFactor,
        visible: false,
        width: 4,
        height: 1,
        visible: false,
        x: e.target.x,
        y: e.target.y - this.height,
        time: t,
        width: 1,
        height: 1,
        width: 8,
    ...
    function i(e, t, s, i) {
        const a = Math.abs(e - s), r = Math.abs(t - i);
    ...
    function n(e) {
        return o(e, e > 1000 ? 2 : 0);
    }
    function o(e, t) {
        return e || (e = 0), e >= 1000000000000000 ? e.toExponential(t).replace('+', '') : e >= 1000000000000 ? (e / 1000000000000).toFixed(t) + 'T' : e >= 1000000000 ? (e / 1000000000).toFixed(t) + 'B' : e >= 1000000 ? (e / 1000000).toFixed(t) + 'M' : e >= 1000 ? (e / 1000).toFixed(t) + 'K' : e.toFixed(t);
    }
    function h(e, t, s, i) {
    ...
    function H(e) {
        ...
        if (e.data.originalEvent.touches && e.data.originalEvent.touches.length > 1) {
            ...
            if (this.dragging) {
                ...
                F(this);
                s(this.dragStartX, this.dragStartY, this.x, this.y) > 5 && (this.hasMoved = true);
                ;
            }
        }
    }
    function F(e) {
        const t = 600 * e.scale.x, s = 600 * e.scale.y;
        e.x > 400 && (e.x = 400);
        e.x + t < 400 && (e.x = 400 - t);
        e.y > 300 && (e.y = 300);
        e.y + s < 300 && (e.y = 300 - s);
    ...
    function E(e) {
        this.hasMoved || v.currentState != v.states.playingLevel || T.spawnZombie(e.data.getLocalPosition(this).x, e.data.getLocalPosition(this).y);
        this.hasMoved = false;
        ;
    }
    function A(e, t) {
        ...
        const i = 600 * s.scale.x, a = 600 * s.scale.y;
        t.x > s.x + i && (t.x = s.x + i);
        t.x < s.x && (t.x = s.x);
        t.y < s.y && (t.y = s.y);
        t.y > s.y + a && (t.y = s.y + a);
        ;
        const r = (t.x - s.x) / s.scale.x, n = (t.y - s.y) / s.scale.y;
        e > 0 ? s.scale.x < 10 && (s.scale.x = s.scale.y = 1.1 * s.scale.x, T.zombieCursor && T.zombieCursor.scale && (T.zombieCursor.scale.x = T.zombieCursor.scale.y = 1.1 * T.zombieCursor.scale.x)) : Math.max(i, a) > 0.8 * Math.min(600, 800) && (s.scale.x = s.scale.y = 0.9 * s.scale.x, T.zombieCursor && T.zombieCursor.scale && (T.zombieCursor.scale.x = T.zombieCursor.scale.y = 0.9 * T.zombieCursor.scale.x));
        s.x = t.x - r * s.scale.x;
        s.y = t.y - n * s.scale.y;
        F(s);
        ;
    ...
    function L(e) {
        e.preventDefault();
        const t = {
            x: e.clientX * (800 / document.body.clientWidth),
            y: e.clientY * (600 / document.body.clientHeight)
        };
        e.deltaY < 0 || e.deltaX < 0 ? A(1, t) : A(-1, t);
    }
    function Z(e = false) {
        e && (c.scale.x = 1, c.scale.y = 1, T.zombieCursor && (T.zombieCursor.scale.x = T.zombieCursor.scale.y = T.zombieCursorScale * 1));
        c.x = (800 - 600 * c.scale.x) / 2;
        c.y = (600 - 600 * c.scale.y) / 2;
        ;
    }
    const G = {
            x: 0,
            ...
            update() {
                ...
                this.width = 800 / c.scale.x;
                this.height = 600 / c.scale.y;
                ;
            }
        }, X = new PIXI.Matrix();
    function U(e, t) {
        ...
        (function (e, t) {
            if (C.vipEscaping && void 0 !== C.vip ? y.alpha += e : (y.alpha -= e, y.alpha < 0 && (y.alpha = 0)), y.alpha > 0) {
                ...
                y.y = 295;
                ;
                const e = c.scale.x, s = c.scale.y, i = c.x, a = c.y;
                c.position.set(0, 0);
    ...
    function N() {
        const e = Math.min(500 + 50 * v.level, 1500), t = Math.random() * e / 3;
        P = {
            x: e + t,
            y: e - t
        };
        x && (x.width = 600, x.height = 600);
        c.hitArea = new PIXI.Rectangle(0, 0, 600, 600);
        ;
    }
    function O() {
        const e = document.body.clientWidth, t = document.body.clientHeight;
        D = {
            x: e,
            y: t,
            defaultScale: Math.max(e, t) / 1000
        };
        200 = Math.max(e, t) / 4;
        ;
    }
    ...
    class q {
        constructor() {
            if (this.cooldownReduction = 0, this.timeExtension = 0, this.costReduction = 0, this.skeleton = new Xe(), this.zombies = new Ae(), this.humans = new Se(), this.spellMap = new Map(), this.spells = [
                    new W(1, 'Time Warp', 'Speed up the flow of time for 30 seconds', '', 90, 30, 0, function () {
        ...
        castSpell(e) {
            ...
            e.onCooldown || e.active || !e.unlocked || e.energyCost - this.costReduction > t.energy || (t.energy -= e.energyCost - this.costReduction, e.onCooldown = true, e.cooldownLeft = e.cooldown * this.cooldownReduction, e.active = true, e.timer = e.duration + this.timeExtension, e.start(), t.sendMessage(e.name));
        }
        castSpellNoMana(e) {
            const t = this.spellMap.get(e);
            t && !t.active && (t.active = true, t.timer = t.duration + this.timeExtension, t.start(), ne.getInstance().sendMessage(t.name));
        }
        updateSpells(e) {
            for (let t = 0; t < this.spells.length; t++) {
                const s = this.spells[t];
                s.onCooldown && !s.active && (s.cooldownLeft -= e, s.cooldownLeft <= 0 && (s.onCooldown = false));
                s.active && (s.timer -= e, s.timer <= 0 && (s.active = false, s.end()));
                ;
            }
        }
    }
    ...
    class ee {
        constructor() {
            if (this.gameModel = ne.getInstance(), this.humans = new Se(), this.discardedWalls = [], this.discardedContainers = [], this.discardedFloorSprites = [], this.buildings = [], this.buildingsByPopularity = [], this.buildingMap = [], this.roadSprite = null, this.roadTexture = null, this.entranceWidth = 16, this.entranceDepth = 16, this.cornerDistance = 16, this.minBuildings = 3, this.wallWidth = 4, this.graveyardCollision = null, this.graveYardLocation = {
                    x: 0,
                    y: 0
                }, this.graveYardPosition = null, this.wallCollisionBuffer = 3, this.fastDistance = i, this.pathFindStepSize = 5, this.dx = 0, this.dy = 0, this.stepsToTake = 10, this.hasHit = false, this.vector = null, this.corner = null, this.hitbuilding = false, this.insideBuilding = false, this.treeSprites = [], this.treeTextures = [], this.armyTextures = [], ee.instance) {
                return ee.instance;
            }
            ee.instance = this;
        }
        ...
        addBuilding(e) {
            ...
            ;
            this.gameModel.level % 5 == 0 && (e.y < 300 ? e.entrance = r.filter(e => e.south)[0] : e.entrance = r.filter(e => e.north)[0]);
            ;
            ;
        ...
        setGraveyardPosition() {
            this.gameModel.level % 5 != 0 || this.gameModel.isBossStage(this.gameModel.level) ? this.graveYardPosition = {
                ...
                x: Math.random() * 600 * 0.8 - 50 + 60,
                y: (Math.random() > 0.5 ? 150 : 450) - 50,
                width: 100,
                height: 100
            };
        ...
        populatePois() {
            ...
            for (this.roadSprite.visible = false, this.gameModel.isBossStage(this.gameModel.level) ? (s = 0, t = 0) : this.gameModel.level % 5 == 0 && (this.roadSprite.visible = true, this.roadSprite.width = 600, this.roadSprite.x = 0, this.roadSprite.y = 252); s > 0 || t > 0;) {
                t--;
                const a = Math.round(5 + Math.random() * (i - 5)), r = Math.sqrt(500 * a);
                s -= a;
                let n, o = false, h = 1000;
                ;
                for (; !o && h > 0;) {
                    h--;
                    n = this.gameModel.level % 5 == 0 ? Math.random() > 0.7 ? {
                        x: 10 + Math.random() * (600 - (20 + r)),
                        y: 10 + Math.random() * (600 - (20 + r)),
                        width: r,
                        height: r
                    } : {
                        x: 10 + Math.random() * (600 - (20 + r)),
                        y: Math.random() > 0.5 ? 300 + this.roadSprite.height / 2 + 8 : 300 - this.roadSprite.height / 2 - 8 - r,
                        width: r,
                        height: r
                    } : {
                        x: 10 + Math.random() * (600 - (20 + r)),
        ...
        populateBuildingMap() {
            if (this.buildingMap = [], this.mapCols = Math.ceil(60), this.mapRows = Math.ceil(60), 0 != this.buildings.length) {
        ...
        randomPositionInBuilding(e) {
            if (!e) {
                const e = Math.random() > 0.5 ? -1 : 1, t = Math.random() > 0.5 ? -1 : 1, s = 150, i = 150;
                return Math.random() > 0.5 ? {
                    x: Math.random() * 600,
                    y: 300 + t * i + Math.random() * t * i
                } : {
                    x: 300 + e * s + Math.random() * e * s,
                    y: Math.random() * 600
                };
            }
            return {
        ...
        checkWall(e, t, s, i) {
            t.y > e.collisionY && t.y < e.collisionY + e.collisionHeight && (t.x < e.collisionX - this.wallCollisionBuffer && s.x > e.collisionX - this.wallCollisionBuffer && (i.x = true, i.validX = e.collisionX - this.wallCollisionBuffer - 1), t.x > e.collisionX + e.collisionWidth + this.wallCollisionBuffer && s.x < e.collisionX + e.collisionWidth + this.wallCollisionBuffer && (i.x = true, i.validX = e.collisionX + e.collisionWidth + this.wallCollisionBuffer + 1));
            t.x > e.collisionX && t.x < e.collisionX + e.collisionWidth && (t.y < e.collisionY - this.wallCollisionBuffer && s.y > e.collisionY - this.wallCollisionBuffer && (i.y = true, i.validY = e.collisionY - this.wallCollisionBuffer - 1), t.y > e.collisionY + e.collisionHeight + this.wallCollisionBuffer && s.y < e.collisionY + e.collisionHeight + this.wallCollisionBuffer && (i.y = true, i.validY = e.collisionY + e.collisionHeight + this.wallCollisionBuffer + 1));
            ;
        }
        checkGraveyard(e, t) {
            const s = new te();
        ...
        pathStepCalc(e, t) {
            ...
            return n *= 1.29289 - (a + r) * n * 0.29289, {
        ...
        willVectorHitBuilding(e, t, s, i) {
            if (this.dx = t.x - e.x, this.dy = t.y - e.y, this.dx < 0 && e.x < s.x - 4) {
                return false;
            }
            ...
            for (this.step = this.pathStepCalc(e, t), this.stepsToTake = Math.min(i / this.pathFindStepSize - this.pathFindStepSize, 30), this.hasHit = false, this.testPosition = {
                    x: e.x,
                    y: e.y
                ...
                this.isInsidePoi(this.testPosition.x, this.testPosition.y, s, 4) && (this.hasHit = true);
                ;
            }
            return this.hasHit;
        }
        ...
        howDoIGetToMyTarget(e, t) {
            if (this.distanceToTarget = this.fastDistance(e.x, e.y, t.x, t.y), this.closeBuilding = this.findBuilding(e), this.insideBuilding = false, this.closeBuilding && (this.insideBuilding = this.isInsidePoi(e.x, e.y, this.closeBuilding, 0), this.insideBuilding)) {
        ...
        populateTrees() {
            ...
            for (; e > 0;) {
                ...
                if (i) {
                    ...
                    this.treeSprites.length > t ? (i = this.treeSprites[t], i.texture = r, i.visible = true) : (i = new PIXI.Sprite(r), this.treeSprites.push(i), g.addChild(i));
                    t++;
                    i.anchor.set(0.5, 1);
                    i.x = s.x;
                    i.y = s.y;
    ...
    class se {
        constructor() {
            if (this.storm = false, this.gameModel = ne.getInstance(), this.costs = {
                    blood: 'blood',
                    parts: 'parts'
                }, this.generatorsApplied = [], this.generators = [
                    new ie(1, 'Simple Machine', this.costs.blood, 1000000, 1.08, 1, 2, 'A simple device that produces 1 part every 2 seconds'),
                    new ie(2, 'Part Duplicator', this.costs.parts, 100, 1.09, 4, 3, 'A more advanced device that produces 4 parts every 3 seconds'),
                    new ie(3, 'Stamp Press', this.costs.parts, 1000, 1.1, 16, 5, 'An industrial press that produces 16 parts every 5 seconds'),
                    new ie(4, 'Conveyor', this.costs.parts, 10000, 1.11, 64, 8, 'A fantastic new invention that produces 64 parts every 8 seconds'),
                    new ie(5, 'Splitter Combiner', this.costs.parts, 100000, 1.12, 192, 10, 'A wondrous machine that produces 192 parts every 10 seconds'),
                    new ie(6, 'Batch Converter', this.costs.parts, 500000, 1.13, 512, 12, 'An astounding contraption that produces 512 parts every 12 seconds')
                ], se.instance) {
                return se.instance;
            }
            se.instance = this;
    ...
    class ae {
        constructor() {
            if (this.gameModel = ne.getInstance(), this.spawnedSavedCreatures = false, this.types = {
                    earthGolem: 1,
                    airGolem: 2,
                    fireGolem: 3,
                    waterGolem: 4
                }, this.creatures = [
                    new re(1, this.types.earthGolem, 'Earth Golem', 3000, 75, 30, 800, 'A golem born from rocks and mud, able to take a lot of punishment and taunt enemies to attack it'),
                    ...
                    new re(3, this.types.fireGolem, 'Fire Golem', 1200, 130, 32, 1000, 'A fireball spewing golem that ignites everything it touches'),
                    new re(4, this.types.waterGolem, 'Water Golem', 1500, 90, 30, 1100, 'A calming golem that restores health to nearby units')
                ], this.creatureScaling = 1.75, this.creatureCostScaling = 1.9, this.creatureCostReduction = 1, ae.instance) {
                return ae.instance;
            }
            ae.instance = this;
        }
        update(e) {
            ...
            for (let s = 0; s < this.creatures.length; s++) {
                this.creatures[s].building ? (this.creatures[s].timeLeft -= e, this.creatures[s].timeLeft < 0 && (this.spawnCreature(this.creatures[s]), this.creatures[s].building = false)) : void 0 !== t[this.creatures[s].type] && t[this.creatures[s].type] < this.creatures[s].autobuild && this.startBuilding(this.creatures[s]);
        ...
        startBuilding(e) {
            e.building || this.canAffordCreature(e) && (this.creaturesBuildingCount() + this.gameModel.creatureCount >= this.gameModel.creatureLimit || (e.building = true, e.timeLeft = e.time, this.gameModel.persistentData.parts -= this.purchasePrice(e)));
        }
        ...
        spawnCreature(e) {
            const t = new Ue(), s = e.baseHealth * Math.pow(this.creatureScaling, e.level - 1) * this.gameModel.golemHealthPCMod, i = e.baseDamage * Math.pow(this.creatureScaling, e.level - 1) * this.gameModel.golemDamagePCMod;
    ...
    class ne {
        constructor() {
            ...
            this.lastSave = 0;
            this.lastPlayFabSave = Date.now() - 15000;
            this.persistentData = {
        ...
        update(e, t) {
            ...
            ;
            this.startTimer < 0 && this.persistentData.autoStart && this.startLevel(this.level);
            this.currentState == this.states.levelCompleted && (this.startTimer < 0 && this.nextLevel());
        ...
        calculateEndLevelBones() {
            this.endLevelBones = 0;
            this.persistentData.boneCollectors > 0 && this.bones.uncollected && (this.endLevelBones = this.bones.uncollected.map(e => e.value).reduce((e, t) => e + t, 0), this.addBones(this.endLevelBones));
            ;
        }
        ...
        addPrestigePoints(e) {
            if (void 0 === this.persistentData.prestigePointsEarned) {
        ...
        loadData() {
            try {
                if (null !== localStorage.getItem(this.storageName)) {
        ...
        calcOfflineProgress() {
            if (this.upgrades.applyUpgrades(), this.upgrades.updateRuneEffects(), this.partFactory.applyGenerators(), this.constructions.partFactory) {
                const e = (Date.now() - this.persistentData.dateOfSave) / 1000, t = this.partFactory.updateLongTime(e);
                if (t > 0) {
                    this.offlineMessage = 'Your factory has generated ' + n(t) + ' parts while you were away';
        ...
        updatePersistentData() {
            ...
            void 0 === this.persistentData.particles && (this.persistentData.particles = true);
        ...
        saveToPlayFab(e = false) {
            if (this.lastPlayFabSave = Date.now(), this.playFabId) {
                ...
                e && (this.resetToBaseStats(), this.setupLevel(), window.location.reload());
            }
        }
    ...
    class oe {
        constructor() {
            if (this.gameModel = ne.getInstance(), this.spells = new q(), this.skeleton = new Xe(), this.partFactory = new se(), this.types = {
                    ...
                    new he(201, 'Cursed Graveyard', this.constructionTypes.graveyard, { blood: 1800 }, 30, 1, 1, 1, null, 'Construct a Cursed Graveyard in the town that will automatically spawn zombies when your energy is at its maximum!', 'Graveyard menu now available!'),
                    ...
                    new he(304, 'Technical Think Tank', this.constructionTypes.TechThinkTank, {
                        bones: 75000000000000,
                        parts: 1000000000000000000
                    ...
                    new le(9, 'Sharpened Teeth', this.types.damage, this.costs.blood, 3000, 1.23, 3, 50, 'Your zombies bites do +3 damage with each rank of Sharpened Teeth.', null, 206),
                    new le(11, 'Razor Claws', this.types.damage, this.costs.blood, 28000, 1.25, 5, 0, 'Your zombies attacks do +5 damage with each rank of Razor Claws.', null, 211),
                    new le(16, 'Killer Instinct', this.types.damage, this.costs.blood, 1000000, 1.27, 8, 0, 'Your zombies attacks do +8 damage with each rank of Killer Instinct.', null, 220),
                    ...
                    new le(10, 'Thick Skull', this.types.health, this.costs.blood, 5000, 1.23, 25, 50, 'Your zombies gain +25 health with each rank.', null, 206),
                    new le(12, 'Battle Hardened', this.types.health, this.costs.blood, 32000, 1.25, 40, 0, 'Your zombies gain +40 health with each rank of Battle Hardened.', null, 211),
                    new le(17, 'Tough as Nails', this.types.health, this.costs.blood, 1000000, 1.27, 100, 0, 'Your zombies gain +100 health with each rank of Tough as Nails.', null, 220),
                    ...
                    new le(4, 'Recycling is Cool', this.types.brainRecoverChance, this.costs.blood, 1000, 1.2, 0.1, 10, 'Why are we wasting so many good brains on this project? Each rank increases your chance to get a brain back from a dead zombie by 10%', null, null),
                    new le(5, 'Your Soul is Mine!', this.types.riseFromTheDeadChance, this.costs.blood, 1500, 1.4, 0.1, 10, 'Using your most powerful blood magic you command the bodies of the dead to rise as your servants! Each rank grants 10% chance that dead humans will turn into zombies.', null, null),
                    new le(6, 'Infected Bite', this.types.infectedBite, this.costs.blood, 3500, 1.4, 0.1, 10, 'Your zombies are now infected with plague and could infect their victims too. Each rank adds 10% chance to inflict damage over time when a zombie attacks a target.', null, 204),
                    new le(7, 'Detonate', this.types.unlockSpell, this.costs.blood, 25000, 1, 3, 1, 'Learn the Detonate spell which can explode all of your zombies into a cloud of plague. Not exactly sure how useful that will be.', 'New spell learned, Detonate!', 209),
                    new le(8, 'Gigazombies?', this.types.unlockSpell, this.costs.blood, 50000, 1, 5, 1, 'Learn the Gigazombies spell which will turn some of your zombies into hulking monstrosities with increased health and damage.', 'New spell learned, Gigazombies!', 209),
                    new le(13, 'Blazing Speed', this.types.burningSpeedPC, this.costs.blood, 30000, 1.25, 0.05, 10, 'The humans are using torches to set your zombies on fire. Perhaps we can turn the tables on them? Each rank increases the movement and attack speed of burning zombies by 5%', null, 207),
                    new le(14, 'Spit it Out', this.types.spitDistance, this.costs.blood, 500000, 1.8, 5, 15, 'The first rank gives your zombies the ability to spit plague at enemies beyond normal attack range. Spit attacks do 50% zombie damage and infect the victim with plague. Subsequent ranks will increase the range of spit attacks.', null, 218),
                    new le(15, 'Runic Syphon', this.types.runicSyphon, this.costs.blood, 34000, 1.9, 0.01, 10, 'Infuse your runes for free! Each rank gives your Runesmith the ability to infuse 1% of your resource income, without consuming it. Additionally when blood and brains reach their storage limit, any additional resources will be infused automatically.', null, 210),
                    new le(19, 'Faster Harpies', this.types.harpySpeed, this.costs.blood, 100000000, 1.07, 2, 20, 'These harpies are way too slow! We have to make them faster. Each rank increases harpy speed by 2', null, 222),
                    new le(20, 'Energy Rush', this.types.energyRate, this.costs.brains, 20, 1.8, 0.5, 20, 'Melting brains down in your cauldron to make smoothies can be beneficial for your health. It also increases your energy rate by 0.5 per second for each rank.', null, null),
                    ...
                    new le(23, 'Blood Harvest', this.types.bloodStoragePC, this.costs.brains, 50, 1.12, 0.1, 0, 'All this brain power has enabled you to devise some superior blood storage methods. Each rank increases your maximum blood by 10%.', null, null),
                    ...
                    new le(25, 'Infected Corpse', this.types.infectedBlast, this.costs.brains, 500, 1.4, 0.1, 10, 'Fill your zombies with so much plague they are ready to explode! Each rank adds 10% chance for a zombie to explode into a cloud of plague upon death.', null, 204),
                    new le(26, 'Energy Charge', this.types.unlockSpell, this.costs.brains, 2000, 1, 2, 1, 'Learn the Energy Charge spell which can drastically increase your energy rate for a short time.', 'New spell learned, Energy Charge!', 209),
                    new le(27, 'What Doesn\'t Kill You', this.types.blastHealing, this.costs.brains, 10000, 1.3, 0.1, 20, 'Plague explosions from zombies and harpies will also heal nearby zombies for 10% of the explosion damage with each rank.', null, 218),
                    new le(28, 'One is Never Enough', this.types.monsterLimit, this.costs.brains, 20000, 1.2, 1, 15, 'We\'re definitely going to need more than one golem to finish the job. Each rank increases your creature limit by 1', null, 220),
                    new le(29, 'Tank Buster', this.types.tankBuster, this.costs.brains, 400000, 1.2, 1, 1, 'Teach your harpies some new tricks. Once bought this upgrade will make your harpies drop fire bombs on tanks during boss stages.', null, 222),
                    ...
                    new le(43, 'Bone Reinforced Tanks', this.types.bloodCap, this.costs.bones, 500, 1.07, 2000, 0, 'Finally! Now that we have a solid construction material we can get to work building better storage for our other resources. Each rank increases blood storage by 2000.', null, null),
                    ...
                    new le(45, 'Earth Freeze', this.types.unlockSpell, this.costs.bones, 5000, 1, 4, 1, 'Learn the Earth Freeze spell which can freeze all humans in place for a short time.', 'New spell learned, Earth Freeze!', 209),
                    new le(46, 'Plague Armor', this.types.plagueArmor, this.costs.bones, 15000, 1.6, 0.02, 10, 'The best defense is a good offense? True in the case of Plague Armor which reduces the damage done by infected humans by 2% per rank.', null, 218),
                    new le(47, 'Bulletproof', this.types.bulletproof, this.costs.bones, 60000, 1.6, 0.05, 15, 'Craft your earth golems from much harder stone. Each rank gives them 5% chance to reflect bullets back to their source.', null, 220),
                    new le(48, 'Bombs Away', this.types.harpyBombs, this.costs.bones, 500000, 1.6, 1, 3, 'Upgrade your harpies so they can carry more than just one bomb at a time.', null, 222),
                    ...
                    new le(61, 'Big Boned', this.types.golemHealthPC, this.costs.parts, 1000, 1.31, 0.02, 0, 'Your golems gain +2% health with each rank of Big Boned.', null, 220),
                    new le(62, 'Hybrid Strength', this.types.HstrengthDmgPC, this.costs.parts, 1000, 1.3, 0.01, 0, 'Animating Golem parts fused with zombie flesh creates a terrifyingly strong Hybrid. Your zombies gain +1% damage with each rank of Hybrid Strength.', null, 301),
                    new le(63, 'Hybrid Shell', this.types.HshellHealthPC, this.costs.parts, 1000, 1.31, 0.01, 0, 'Golem armor shell provides extra protection for your fleshy zombies. Your zombies gain +1% health with each rank of Hybrid Shell.', null, 301),
                    new le(64, 'Advanced Cyrogenic Vats', this.types.CyroVatPC, this.costs.parts, 1000, 1.4, 0.1, 0, 'Cooling these Brains further makes them last much longer. Your brain storage increases +10% with each rank of Advanced Cyrogenic Vats.', null, 302),
                    new le(65, 'Golem Part Plague Vats', this.types.PlagueVatPC, this.costs.brains, 1000, 1.35, 0.01, 0, 'Using specialized Golem Parts allows for advancements in plague research. Plague Damage increases +1% with each rank of Golem Part Plague Vats.', null, 302),
                    new le(66, 'Cloning Replicator', this.types.CloningRep1PC, this.costs.parts, 1000000000000, 1.26, 0.05, 0, 'Mass produced Cloning Replicators allows for much greater use out of each Brain obtained. Brain Income increases +5% with each rank of Cloning Replicator.', null, 303),
                    new le(67, 'Blood Synthezizer', this.types.BloodSynPC, this.costs.parts, 2000000000000, 1.25, 0.05, 0, 'Artificial Blood can augment what we already get allowing for more of everything. Blood Income increases +5% with each rank of Blood Synthesizer.', null, 303),
                    new le(68, 'Synthetic Bone Fabricator', this.types.SynBonePC, this.costs.parts, 3000000000000, 1.24, 0.05, 0, 'Synthetic Bones made from Golem Parts?  Genius! Bone Income increases +5% with each rank of Synthetic Bone Fabricator.', null, 303),
                    new le(69, 'Insectoid Parts Assemblers', this.types.SmolPartsPC, this.costs.parts, 4000000000000, 1.23, 0.05, 0, 'Insect sized and shaped assemblers are far more efficient at maufacturing Golem parts. Parts Income increases +5% with each rank of Insectoid Parts Assemblers.', null, 303),
                    new le(70, 'Golem Avionic', this.types.AvionicsPC, this.costs.parts, 200000000000000000, 1.2, 2, 50, 'Building on the success of hybrid zombies, small golem parts can enhance Harpy-Golem Hybrids. Harpy Speed +2 with each rank of Golem Avionics.', null, 304),
                    new le(71, 'Electro-Shock Collars', this.types.ShockPC, this.costs.parts, 300000000000000, 1.2, 0.0025, 0, 'Using shock collars tuned to the Hybrid Zombie\'s nervous system causes them to attack at blinding speeds! Attack Speed +0.25% with each rank of Electro-Shock Collars.', null, 304),
                    new le(72, 'Power Regulators', this.types.EnergyCost, this.costs.parts, 1000000000000000000, 1.2, 1, 30, 'Golem parts assembled around the graveyard can help regulate and attune necrotic power. Reduces zombie summoning cost by 1 with each rank of Power Regulators.', null, 304),
                    new le(73, 'Sephirin\'s Reputation', this.types.prest_multPC, this.costs.blood, 100000000000000000000, 1.25, 0.03, 0, 'Astounding levels of blood sacrificed can enhance your reputation with dark entities in the Void. +3% Zombie Heatlh and Damage per rank', null, 304),
                    new le(74, 'Strider\'s Mathemagics', this.types.SkeleMove, this.costs.parts, 1000000000000000000, 6, 1, 10, 'Using Archane Mathemagics you imbue your Skeleton Champion with golem based ligaments. +1 Movement Speed per rank.(In testing)', null, 304)
                    ...
                    new le(110, 'Master of Death', this.types.energyCost, this.costs.prestigePoints, 1000, 1, 1, 5, 'Each rank reduces the energy cost of summoning a zombie by 1', null, null),
                    ...
                    new le(115, 'Talent Point', this.types.talentPoint, this.costs.prestigePoints, 100, 1.175, 1, 0, 'Additional skeleton talent point', null, null)
                ], oe.instance) {
                return oe.instance;
            }
            oe.instance = this;
        ...
        applyUpgrade(e, t) {
            ...
            case this.types.SkeleMove:
                return void (this.gameModel.SkeleMoveMod += e.effect * t), this.skeleton.moveSpeed += e.effect * t;
            ...
            case this.types.HstrengthDmgPC:
                return void (this.gameModel.zombieDamagePCMod *= Math.pow(1 + e.effect, t)), this.gameModel.HstrengthDmgPCMod *= Math.pow(1 + e.effect, t);
            case this.types.HshellHealthPC:
                return void (this.gameModel.zombieHealthPCMod *= Math.pow(1 + e.effect, t)), this.gameModel.HshellHealthPCMod *= Math.pow(1 + e.effect, t);
            case this.types.CyroVatPC:
                return void (this.gameModel.brainsMax *= Math.pow(1 + e.effect, t)), this.gameModel.CyroVatPCMod *= Math.pow(1 + e.effect, t);
            case this.types.PlagueVatPC:
                return void (this.gameModel.PlagueVatPCMod *= Math.pow(1 + e.effect, t));
            case this.types.CloningRep1PC:
                return void (this.gameModel.brainsPCMod *= Math.pow(1 + e.effect, t)), this.gameModel.CloningRep1PCMod *= Math.pow(1 + e.effect, t);
            case this.types.BloodSynPC:
                return void (this.gameModel.bloodPCMod *= Math.pow(1 + e.effect, t)), this.gameModel.BloodSynPCMod *= Math.pow(1 + e.effect, t);
            case this.types.SynBonePC:
                return void (this.gameModel.bonesPCMod *= Math.pow(1 + e.effect, t)), this.gameModel.SynBonePCMod *= Math.pow(1 + e.effect, t);
            case this.types.SmolPartsPC:
                return void (this.gameModel.partsPCMod *= Math.pow(1 + e.effect, t)), this.gameModel.SmolPartsPCMod *= Math.pow(1 + e.effect, t);
            case this.types.AvionicsPC:
                return void (this.gameModel.harpySpeed += e.effect * t), this.gameModel.AvionicsPCMod += e.effect * t;
            case this.types.ShockPC:
                return void (this.attackSpeed *= Math.pow(1 + e.effect, t)), this.gameModel.ShockPCMod *= Math.pow(1 + e.effect, t);
            case this.types.EnergyCost:
                return void (this.gameModel.zombieCost -= e.effect * t), this.gameModel.EnergyCostMod -= e.effect * t;
            case this.types.prest_multPC:
                return void (this.gameModel.zombieDamagePCMod *= Math.pow(1 + e.effect, t)), this.gameModel.zombieHealthPCMod *= Math.pow(1 + e.effect, t), this.gameModel.prest_multPCMod *= Math.pow(1 + e.effect, t);
        ...
        calculateWithPrestigeRankBonus(e, t) {
            ...
            for (let i = 1; i <= t - 60; i++) {
                multiplier *= 1 + e.effect * Math.pow(1.05, i);
            }
            return multiplier;
        }
        applyConstructionUpgrade(e) {
            ...
            case this.constructionTypes.pit:
                return this.gameModel.bloodMax += 1000000 * e.rank, void (this.gameModel.brainsMax += 100000 * e.rank);
            ...
            case this.constructionTypes.partFactory:
                return this.gameModel.constructions.partFactory = true, void (this.gameModel.constructions.factory = true);
            case this.constructionTypes.monsterFactory:
                return this.gameModel.constructions.monsterFactory = true, void (this.gameModel.constructions.factory = true);
        ...
        purchaseUpgrade(e, t = true) {
            if (this.canAffordUpgrade(e)) {
                ...
                case this.costs.bones:
                    ...
                    break;
                case this.costs.prestigePoints:
                    i = true, this.gameModel.persistentData.prestigePointsToSpend -= this.upgradePrice(e);
                    break;
                case this.costs.parts:
        ...
        consumeResources(e) {
            let t = true;
            return this.gameModel.persistentData.currentConstruction.shortfall = {}, e.energy && e.energy > this.gameModel.energy && (t = false, this.gameModel.persistentData.currentConstruction.shortfall.energy = true), e.blood && e.blood > this.gameModel.persistentData.blood && (t = false, this.gameModel.persistentData.currentConstruction.shortfall.blood = true), e.brains && e.brains > this.gameModel.persistentData.brains && (t = false, this.gameModel.persistentData.currentConstruction.shortfall.brains = true), e.bones && e.bones > this.gameModel.persistentData.bones && (t = false, this.gameModel.persistentData.currentConstruction.shortfall.bones = true), e.parts && e.parts > this.gameModel.persistentData.parts && (t = false, this.gameModel.persistentData.currentConstruction.shortfall.parts = true), !!t && (this.gameModel.persistentData.currentConstruction.shortfall = false, e.energy && (this.gameModel.energy -= e.energy), e.blood && (this.gameModel.persistentData.blood -= e.blood), e.brains && (this.gameModel.persistentData.brains -= e.brains), e.bones && (this.gameModel.persistentData.bones -= e.bones), e.parts && (this.gameModel.persistentData.parts -= e.parts), true);
        }
            ...
            if (this.gameModel.autoUpgrades) {
                ...
                if (this.gameModel.constructions.factory) {
                    for (let e = 0; e < this.partFactory.generators.length; e++) {
                        this.partFactory.generators[e].auto && this.partFactory.purchaseGenerator(this.partFactory.generators[e], false);
                    }
                }
            }
        ...
        startConstruction(e) {
            ...
            e.costs.energy && (0 = e.costs.energy / (t ? 5 : e.time));
            e.costs.blood && (0 = e.costs.blood / (t ? 5 : e.time));
            e.costs.brains && (0 = e.costs.brains / (t ? 5 : e.time));
            e.costs.bones && (0 = e.costs.bones / (t ? 5 : e.time));
            e.costs.parts && (0 = e.costs.parts / (t ? 5 : e.time));
        ...
        shatterPercent(e) {
            const t = 100000000 * Math.pow(1.5, this.gameModel.persistentData.runeshatter);
            return Math.floor(100 * Math.min(1, e.blood / t));
        }
        shatterBloodCost(e) {
            return Math.max(0, 100000000 * Math.pow(1.5, this.gameModel.persistentData.runeshatter) - e.blood);
        }
        shatterEffect() {
        ...
        updateRuneEffects() {
            ...
            for (let t = 0; t < this.runeCalculations.length; t++) {
                const s = this.runeCalculations[t], i = this.gameModel.persistentData.runes[s.rune][s.cost];
                if (i > 0) {
    ...
    class de {
        ...
        createTrophy(e, t, s) {
            const i = Math.round(e / 5) - 1, a = Math.floor(i / this.trophyStats.length), r = this.trophyStats[i - a * this.trophyStats.length];
            return {
                level: e,
                type: r.type,
        ...
        getTrophyTotals() {
            const e = this.getTrophyList().filter(e => e.owned), t = [];
        ...
        getAquiredTrophyList() {
            ...
            for (let t = 0; t < this.gameModel.persistentData.trophies.length; t++) {
                e.push(this.createTrophy(this.gameModel.persistentData.trophies[t], true, false));
            }
            return e;
        }
    }
    ...
    class Se {
        constructor() {
            if (this.maxWalkSpeed = 15, this.maxRunSpeed = 35, this.minSecondsTostand = 1, this.maxSecondsToStand = 60, this.chanceToStayInCurrentBuilding = 0.95, this.textures = [], this.doctorTextures = [], this.humans = [], this.discardedHumans = [], this.aliveHumans = [], this.graveyardAttackers = [], this.humansPerLevel = 50, this.maxHumans = 1000, this.scaling = 2, this.visionDistance = 60, this.vipEscaping = false, this.fleeChancePerZombie = 0.1, this.fleeTime = 10, this.scanTime = 3, this.attackDistance = 20, this.moveTargetDistance = 3, this.attackSpeed = 2, this.attackDamage = 5, this.fadeSpeed = 0.1, this.plagueTickTimer = 5, this.healTickTimer = 5, this.burnTickTimer = 5, this.smokeTimer = 0.3, this.fastDistance = i, this.frozen = false, this.pandemic = false, this.graveYardPosition = null, this.drawTargets = false, Se.instance) {
                return Se.instance;
            }
            Se.instance = this;
        }
        ...
        damageHuman(e, t) {
            ...
            e.health <= 0 && !e.flags.dead && (this.bones.newBones(e.x, e.y), e.flags.dead = true, this.gameModel.addBrains(1), this.skeleton.addXp(this.gameModel.level), this.skeleton.testForLoot(), e.flags.tank ? (this.blasts.newDroneBlast(e.x, e.y - 5), this.fragments.newFragmentExplosion(e.x, e.y - 5, 8086798), e.visible = false) : e.textures = e.deadTexture, e.flags.vip && (this.vipText.visible = false, this.trophies.trophyAquired(this.gameModel.level), setTimeout(() => {
                this.vipEscaping = false;
            }, 2000)));
            this.army.assaultStarted || Math.random() > 0.9 && this.gameModel.isBossStage(this.gameModel.level) && (this.army.assaultStarted = true, this.gameModel.sendMessage('The assault has begun!'));
            ;
        }
        updateBurns(e, t) {
            e.timer.burnTick -= t;
        ...
        getMaxHealth(e) {
            return e < 7 ? 10 * (e + 4) : e < 12 ? 20 * (e - 1) : e < 16 ? 25 * (e - 3) : e < 29 ? 50 * (e - 9) : e < 49 ? 100 * (e - 19) : e < 64 ? 300 * (e - 39) : e < 85 ? 500 * (e - 49) : e < 499 ? 17800 * Math.pow(1.015, e - 84) : e < 999 ? 8500000 * Math.pow(1.03, e - 499) : e < 1499 ? 980000000000000000 * Math.pow(1.021, e - 1499) : e > 2299 ? 8.45e+25 * Math.pow(1.025, e - 2299) : 4500000000000 * Math.pow(1.025, e - 999);
        }
        getAttackDamage() {
        ...
        setupVipText(e) {
            this.vipText || (this.vipText = new fe('VIP', {
                ...
                strokeThickness: 5,
                align: 'center'
            }), this.vipText.anchor.set(0.5, 1), this.vipText.scale.x = 0.25, this.vipText.scale.y = 0.25, b.addChild(this.vipText));
        ...
        populate() {
            ...
            for (let a = 0; a < e; a++) {
                ...
                if (t > 0) {
                    ...
                    const t = Math.random() < this.getTorchChance(), s = Math.floor(3 * Math.random()) + (t ? 3 : 0);
                ...
                ;
                ;
                i && !e.flags.doctor && (e.flags.vip = true, this.vip = e, i = false, e.maxHealth = e.health = 2 * s, this.setupVipText(e));
        ...
        update(e) {
            ...
            const t = [], s = this.zombies.aliveZombies;
        ...
        updateDeadHumanFading(e, t) {
            if (e.visible) {
                if (e.alpha > 0.5 && e.alpha - this.fadeSpeed * t <= 0.5 && !e.flags.tank && Math.random() < this.gameModel.riseFromTheDeadChance) {
                    return this.zombies.createZombie(e.x, e.y, e.flags.dog), e.visible = false, void g.removeChild(e);
                }
                ;
                if (e.alpha < 0) {
                    e.visible = false;
        ...
        changeState(e, t) {
            ...
            case ce.fleeing:
                ...
                break;
            case ce.escaping:
                e.play(), e.maxSpeed = this.maxRunSpeed, e.target = this.escapeTarget, this.exclamations.newExclamation(e), this.gameModel.sendMessage('The VIP is escaping!'), this.vipEscaping = true;
                break;
            case ce.attacking:
        ...
        inflictBurn(e, t) {
            e.flags.torchBearer && (t.flags.burning ? t.burnDamage += this.attackDamage : (this.exclamations.newFire(t), t.burnDamage = this.attackDamage), t.flags.burning = true);
        }
        burnHuman(e, t) {
            e && (e.flags.burning ? e.burnDamage += t : (e.timer.burnTick = this.burnTickTimer, e.timer.smoke = this.smokeTimer, this.exclamations.newFire(e), e.burnDamage = t), e.flags.burning = true);
        }
        updatePlague(e, t) {
        ...
        pandemicBullet(e) {
            for (let t = 0; t < this.aliveHumans.length; t++) {
                Math.abs(this.aliveHumans[t].x - e.x) < 30 && Math.abs(this.aliveHumans[t].y - e.y) < 30 && Math.random() < 0.3 && this.bullets.newBullet(e, this.aliveHumans[t], this.gameModel.zombieDamage / 2, true);
            }
        }
        healHuman(e) {
        ...
        updateHuman(e, t, s) {
            ...
            case ce.fleeing:
                ...
                break;
            case ce.escaping:
                this.fastDistance(e.position.x, e.position.y, e.target.x, e.target.y) < this.moveTargetDistance ? (this.smoke.newDroneCloud(e.x, e.y), e.flags.dead = true, e.zombieTarget = void 0, e.visible = false, this.vipText.visible = false, this.gameModel.sendMessage('The VIP has escaped!'), this.gameModel.vipEscaped(), setTimeout(() => {
                    this.vipEscaping = false;
                }, 2000)) : this.updateHumanSpeed(e, t);
                break;
            case ce.attacking:
        ...
        scanForZombies(e, t) {
            ...
            for (let i = 0; i < t.length; i++) {
                if (!t[i].flags.dead && Math.abs(t[i].x - e.x) < e.visionDistance && Math.abs(t[i].y - e.y) < e.visionDistance && (e.zombieTarget = t[i], s++, s > 9)) {
                    return s;
                }
            }
            return s;
    ...
    class ke {
        constructor() {
            if (this.maxWalkSpeed = 15, this.maxRunSpeed = 40, this.police = [], this.discardedPolice = [], this.walkTexture = [], this.deadTexture = [], this.dogTexture = [], this.deadDogTexture = [], this.policeDogLevel = 20, this.policePerLevel = 1, this.attackSpeed = 2, this.attackDamage = 16, this.attackDistance = 20, this.moveTargetDistance = 5, this.shootDistance = 110, this.visionDistance = 150, this.scaling = 2, this.dogScaling = 1.3, this.radioTime = 30, ke.instance) {
                return ke.instance;
            }
            ke.instance = this;
        }
        ...
        populate() {
            ...
            const e = this.getMaxPolice(), t = this.getMaxHealth(), s = 0.6 * t;
            this.getAttackDamage();
            for (let i = 0; i < e; i++) {
                let e;
        ...
        update(e, t) {
            ...
            for (let i = 0; i < this.police.length; i++) {
                ...
                this.police[i].flags.dead || (this.humans.aliveHumans.push(this.police[i]), s++);
                ;
            }
        ...
        updatePolice(e, t, s) {
            ...
            case ue.standing:
                ...
                break;
            case ue.walking:
                i(e.position.x, e.position.y, e.target.x, e.target.y) < this.moveTargetDistance ? (e.target = false, e.zombieTarget = null, e.timer.standing = this.humans.randomSecondsToStand(), this.changeState(e, ue.standing)) : this.humans.updateHumanSpeed(e, t);
                break;
            case ue.running:
    ...
    class Te {
        constructor() {
            if (this.maxWalkSpeed = 20, this.maxRunSpeed = 50, this.armymen = [], this.discardedArmymen = [], this.textures = [], this.aliveZombies = [], this.armyPerLevel = 0.9, this.attackSpeed = 2, this.attackDamage = 20, this.attackDistance = 25, this.moveTargetDistance = 5, this.shootDistance = 130, this.visionDistance = 200, this.scaling = 2, this.shotsPerBurst = 3, this.droneStrikeTimer = 0, this.droneStrikeTime = 35, this.assaultStarted = false, this.droneStrike = null, this.droneActive = false, this.droneBlastRadius = 35, Te.instance) {
                return Te.instance;
            }
            Te.instance = this;
        }
        ...
        populate() {
            if (this.map = new ee(), this.zombies = new Ae(), this.humans = new Se(), this.gameModel = ne.getInstance(), this.graveyard = new Oe(), this.bullets = new rt(), this.assaultStarted = false, this.blasts = new nt(), this.exclamations = new it(), 0 == this.textures.length) {
                for (let e = 0; e < 3; e++) {
                    const t = [];
                    for (let s = 0; s < 3; s++) {
            ...
            const e = this.getMaxArmy(), t = this.getMaxHealth();
            this.getAttackDamage();
        ...
        update(e, t) {
            ...
            for (let i = 0; i < this.armymen.length; i++) {
                ...
                this.armymen[i].flags.dead || (this.humans.aliveHumans.push(this.armymen[i]), this.armymen[i].attackingGraveyard && this.humans.graveyardAttackers.push(this.armymen[i]), s++);
                ;
            }
        ...
        updateArmy(e, t, s) {
            ...
            switch (e.timer.attack -= t, e.timer.scan -= t, e.flags.infected && this.humans.updatePlague(e, t), e.flags.burning && this.humans.updateBurns(e, t), !e.graveYardTarget && (!e.zombieTarget || e.zombieTarget.flags.dead) && e.timer.scan < 0 && (this.humans.scanForZombies(e, s) > 3 && this.droneActive && this.droneStrikeTimer < 0 && this.callDroneStrike(e, s), this.assaultStarted && e.rocketlauncher && Math.random() > 0.98 && (e.graveYardTarget = this.graveyard.target, e.attackingGraveyard = true)), this.decideStateOnZombieDistance(e), e.armyState) {
            case pe.standing:
            ...
            case pe.attacking:
                ...
                break;
            case pe.shooting:
                e.graveYardTarget || e.zombieTarget && !e.zombieTarget.flags.dead ? (e.target = null !== (r = e.graveYardTarget) && void 0 !== r ? r : e.zombieTarget, e.scale.x = e.target.x > e.x ? this.scaling : -this.scaling, e.timer.attack < 0 && (e.shotsLeft = this.shotsPerBurst, e.minigun && (e.shotsLeft = 3 * this.shotsPerBurst), e.rocketlauncher && (e.shotsLeft = 1), e.timer.attack = e.rocketlauncher ? 1.5 * this.attackSpeed : this.attackSpeed, e.shotTimer = 0), e.shotsLeft > 0 && (e.shotTimer -= t, e.shotTimer < 0 && (e.shotTimer = 0.15, e.minigun && (e.shotTimer = 0.08), this.bullets.newBullet(e, e.target, e.rocketlauncher ? 1.2 * this.attackDamage : e.minigun ? this.attackDamage / 2 : this.attackDamage, false, e.rocketlauncher), e.shotsLeft--))) : this.changeState(e, pe.standing);
            }
        }
        callDroneStrike(e, t) {
            let s = 0;
        ...
        updateDroneStrike(e, t) {
            if (this.droneStrike) {
                if (this.droneStrike.timer -= e, this.droneStrike.startedBombing || (this.droneStrike.text || (this.droneStrike.text = new PIXI.Text('3', {
                        ...
                        x: 0.5,
                        y: 1
                    }, this.droneStrike.text.scale.x = 0.5, this.droneStrike.text.scale.y = 0.5, b.addChild(this.droneStrike.text), this.droneStrike.laser = new PIXI.Graphics(), b.addChild(this.droneStrike.laser)), this.droneStrike.text.text = Math.ceil(this.droneStrike.timer), this.droneStrike.text.x = this.droneStrike.target.x, this.droneStrike.text.y = this.droneStrike.target.y - 30, this.droneStrike.laser.clear(), this.droneStrike.laser.lineStyle(1, 16711680), this.droneStrike.laser.moveTo(this.droneStrike.caller.x, this.droneStrike.caller.y - 10), this.droneStrike.laser.lineTo(this.droneStrike.target.x, this.droneStrike.target.y - 10)), (this.droneStrike.caller.dead || this.droneStrike.target.dead) && !this.droneStrike.startedBombing) {
                    return b.removeChild(this.droneStrike.text), b.removeChild(this.droneStrike.laser), this.droneStrike = false, void (this.droneStrikeTimer = 0);
                }
                if (this.droneStrike.timer < 0) {
                    this.droneStrike.startedBombing || (b.removeChild(this.droneStrike.text), b.removeChild(this.droneStrike.laser), this.droneStrike.startedBombing = true);
                    this.droneBomb(t);
    ...
    class De {
        constructor() {
            if (this.speed = 20, this.tanks = [], this.aliveTanks = [], this.attackDamage = 0, this.attackSpeed = 3, this.scaling = 3, this.moveTargetDistance = 20, this.shootDistance = 300, this.aliveZombies = null, De.instance) {
                return De.instance;
            }
            De.instance = this;
        }
        ...
        populate() {
            ...
            const e = this.getMaxTanks(), t = this.getMaxHealth();
            this.getAttackDamage();
            for (let s = 0; s < e; s++) {
                ...
                ;
                e.anchor.set(0.5, 1);
                e.turretSprite.anchor.set(0.46875, 0.46875);
                ;
                ;
                e.play();
                e.turretSprite.x = 0;
        ...
        updateTank(e, t, s) {
            ...
            switch (e.timer.attack -= t, e.timer.scan -= t, e.flags.burning && this.humans.updateBurns(e, t), !e.attackingGraveyard && (!e.zombieTarget || e.zombieTarget.flags.dead) && e.timer.scan < 0 && (this.humans.scanForZombies(e, s), this.army.assaultStarted && Math.random() > 0.9 && (e.graveYardTarget = this.graveyard.target, e.attackingGraveyard = true)), this.decideStateOnZombieDistance(e), e.tankState) {
            case ge.patrolling:
                e.target || (e.target = this.map.randomPositionInBuilding(null)), i(e.position.x, e.position.y, e.target.x, e.target.y) < this.moveTargetDistance ? (e.target = false, e.zombieTarget = null) : this.humans.updateHumanSpeed(e, t);
                break;
            case ge.attacking:
                ...
                break;
            case ge.shooting:
                e.graveYardTarget || e.zombieTarget && !e.zombieTarget.flags.dead ? e.timer.attack < 0 && (e.timer.attack = this.attackSpeed, this.bullets.newBullet(e, e.graveYardTarget || e.zombieTarget, this.attackDamage, false, true)) : this.changeState(e, ge.patrolling);
            }
        ...
        decideStateOnZombieDistance(e) {
            var t;
            if (e.graveYardTarget || e.zombieTarget && !e.zombieTarget.flags.dead) {
                if (e.target = null !== (t = e.graveYardTarget) && void 0 !== t ? t : e.zombieTarget, i(e.position.x, e.position.y, e.target.x, e.target.y) > this.shootDistance) {
    ...
    class ze extends PIXI.Text {
        ...
        updateCritText(e) {
            this.visible && (this.y -= this.speed * e, this.fadeTime -= e, this.fadeTime < 0 && (this.alpha -= 2 * e, this.alpha < 0 && (this.visible = false, Re.push(this))));
        }
        reset() {
            this.fadeTime = 0.5;
            this.alpha = 1;
    ...
    class Ae {
        constructor() {
            if (this.zombies = [], this.discardedZombies = [], this.aliveZombies = [], this.aliveHumans = [], this.zombiePartition = [], this.scaling = 2, this.moveTargetDistance = 15, this.attackDistance = 15, this.attackSpeed = 3, this.targetDistance = 100, this.fadeSpeed = 0.1, this.refundChance = 0, this.currId = 1, this.scanTime = 3, this.textures = [], this.dogTexture = [], this.deadDogTexture = [], this.maxSpeed = 10, this.zombieCursor = null, this.zombieCursorText = null, this.zombieCursorScale = 3, this.mouseOutOfBounds = false, this.burnTickTimer = 5, this.bloodpact = 1, this.bloodborn = 0, this.gigamutagen = 0, this.gigamutationTimer = 10, this.smokeTimer = 0.3, this.fastDistance = i, this.magnitude = t, this.detonate = false, this.super = false, this.reactionTime = 0, this.graveyardAttackers = [], this.spaceNeeded = 3, Ae.instance) {
                return Ae.instance;
            }
            Ae.instance = this;
        }
        ...
        damageZombie(e, t, s) {
            if (e.graveyard) {
                ...
                e.health <= 0 && !e.flags.dead && (this.bones.newBones(e.x, e.y), e.flags.dead = true, e.flags.golem && this.refundChance > 0 && (this.model.sendMessage('Golem Refunded!'), this.creatureFactory.refundParts(e, this.refundChance)), Math.random() < this.model.infectedBlastChance && this.causePlagueExplosion(e, 0.2 * e.maxHealth, true, false), e.textures = e.deadTexture, e.gotoAndStop(0), Math.random() < this.model.brainRecoverChance && this.model.addBrains(1));
        ...
        causePlagueExplosion(e, t, s = true, i = false) {
            ...
            ;
            for (let s = 0; s < this.aliveHumans.length; s++) {
                Math.abs(this.aliveHumans[s].x - e.x) < a && Math.abs(this.aliveHumans[s].y - e.y) < a && this.fastDistance(e.x, e.y, this.aliveHumans[s].x, this.aliveHumans[s].y) < a && (this.inflictPlague(this.aliveHumans[s]), this.humans.damageHuman(this.aliveHumans[s], t));
            }
        ...
        partitionInsert(e, t) {
            const s = Math.round(t.x / 10), i = Math.round(t.y / 10);
            e[s] || (e[s] = []);
            e[s][i] || (e[s][i] = []);
            e[s][i].push(t);
            ;
        ...
        partitionGetNeighbours(e) {
            const t = [], s = Math.round(e.x / 10), i = Math.round(e.y / 10);
        ...
        update(e) {
            ...
            for (let i = 0; i < this.zombies.length; i++) {
                this.zombies[i].visible && (this.updateZombie(this.zombies[i], e), this.zombies[i].flags.dead || (t.push(this.zombies[i]), this.partitionInsert(s, this.zombies[i])));
            }
            if (this.model.zombieCount = t.length, this.aliveZombies = t, this.zombiePartition = s, this.model.energy >= this.model.zombieCost && this.model.currentState == this.model.states.playingLevel) {
                if (this.zombieCursor.visible = !this.mouseOutOfBounds, false && !this.mouseOutOfBounds) {
        ...
        detonateZombie(e) {
            (e.state == be.attackingTarget || 0 == this.aliveHumans.length && Math.random() < 0.05) && (this.bones.newBones(e.x, e.y), e.flags.dead = true, this.causePlagueExplosion(e, e.maxHealth, true, true), Math.random() < this.model.brainRecoverChance && this.model.addBrains(1));
        }
        updateZombie(e, t) {
            var s;
            if (e.flags.dead) {
                ...
                return e.alpha -= this.fadeSpeed * t, void (e.alpha < 0 && (e.visible = false, g.removeChild(e)));
            }
            ...
            case be.movingToTarget: {
                    ...
                    e.timer.attack < 0 && s < this.model.spitDistance && (this.bullets.newBullet(e, e.target, this.model.zombieDamage / 2, true), e.timer.attack = this.attackSpeed * (1 / (this.model.runeEffects.attackSpeed * this.model.ShockPCMod)));
        ...
        updateZombieSpeed(e, t) {
            ...
            if (e.timer.target && e.targetVector || (e.timer.target = 0), e.timer.target -= t, e.timer.target <= 0 && (e.targetVector = this.map.howDoIGetToMyTarget(e, e.target), e.timer.target = this.reactionTime), this.model.gameSpeed > 1 || e.flags.dog) {
                ...
                ;
                ;
                const i = this.dotProduct(e.xSpeed, e.ySpeed), a = Math.pow(Math.max(this.maxSpeed * e.speedMultiplier, 8), 2);
                if (i > a) {
                    ;
                    ;
                }
            ...
            i && (i.x && (e.xSpeed = 0), i.y && (e.ySpeed = 0), s = {
                x: e.position.x + e.xSpeed * t,
                y: e.position.y + e.ySpeed * t
            }, i.x && (s.x = i.validX), i.y && (s.y = i.validY));
    ...
    class Xe {
        constructor() {
            if (this.skeletons = [], this.aliveSkeletons = [], this.discardedSprites = [], this.aliveHumans = [], this.scaling = 1, this.moveTargetDistance = 15, this.attackDistance = 25, this.attackSpeed = 3, this.targetDistance = 100, this.fadeSpeed = 0.1, this.currId = 1, this.scanTime = 3, this.spawnTimer = 0, this.respawnTime = 10, this.moveSpeed = 40, this.lastKillingBlow = 0, this.randomSpells = [], this.lootChance = 0.001, this.spellTimer = 3, this.textures = {
                    set: false,
                    up: [],
                    down: [],
                    left: [],
                    ...
                    left: 4,
                    dead: 5
                }, this.burnTickTimer = 5, this.smokeTimer = 0.3, this.fastDistance = i, this.magnitude = t, this.damageZombie = null, this.searchClosestTarget = null, this.updateBurns = null, this.updateZombieRegen = null, this.causePlagueExplosion = null, this.inflictPlague = null, this.healZombie = null, this.setSpeedMultiplier = null, this.storageName = 'incremancerskele', this.talentsStorageName = 'incremancertalents', this.persistent = {
                    xpRate: 0,
                    skeletons: 0,
                    level: 1,
                    xp: 0,
        ...
        populate() {
            ...
            for (let t = 0; t < this.skeletons.length; t++) {
                this.skeletons[t].flags.dead ? (this.discardedSprites.push(this.skeletons[t]), g.removeChild(this.skeletons[t])) : (e.push(this.skeletons[t]), this.skeletons[t].x = this.graveyard.sprite.x, this.skeletons[t].zIndex = this.skeletons[t].y = this.graveyard.sprite.y + (this.graveyard.level > 2 ? 8 : 0), this.skeletons[t].target = null, this.skeletons[t].state = be.lookingForTarget, this.skeletons[t].timer.scan = 0);
            }
            this.skeletons = e;
            this.aliveSkeletons = [];
        ...
        updateCreature(e, t) {
            ...
            switch (this.boneshield > 0 && e.boneshield < this.boneshield && (e.boneshieldTimer -= t, e.boneshieldTimer < 0 && (e.boneshieldTimer = 10 / this.boneshield, e.boneshield++)), this.boneshield ? (e.boneshieldContainer.visible = true, e.boneshieldContainer.update(e.boneshield), e.boneshieldContainer.rotation += t) : e.boneshieldContainer.visible = false, this.darkorb > 0 && (this.darkorbTimer -= t, this.darkorbTimer < 0 && e.target && !e.target.flags.dead && (this.darkorbTimer = this.darkorb, this.bullets.newBullet(e, e.target, this.calculateDamage(e), false, false, false, true))), e.timer.attack -= t, e.timer.scan -= t, e.timer.ability -= t, this.model.runeEffects.healthRegen > 0 && this.updateZombieRegen(e, t), e.flags.burning && !e.immuneToBurns && this.updateBurns(e, t), e.timer.ability < 0 && (e.timer.ability = 4), e.target && !e.target.flags.dead || (e.state = be.lookingForTarget, e.timer.target = 0, e.timer.scan = 0), e.state) {
            case be.lookingForTarget:
                    ...
                    if (s < this.attackDistance) {
                        if (e.timer.attack < 0 && !e.target.flags.dead && (this.humans.damageHuman(e.target, this.calculateDamage(e)), e.target.flags.dead && this.killingBlow(e.target), e.timer.attack = this.attackSpeed * (1 / (this.model.runeEffects.attackSpeed * this.model.ShockPCMod)), e.flags.burning && (e.timer.attack *= 1 / this.model.burningSpeedMod), this.randomSpells.length > 0)) {
                            for (let e = 0; e < this.randomSpells.length; e++) {
                                this.spellTimer < 0 && Math.random() < 0.07 + this.increaseChance && (this.spells.castSpellNoMana(this.randomSpells[e]), this.spellTimer = 3);
                            }
                        }
        ...
        killingBlow(e) {
            ...
            if (this.lastKillingBlow <= 0) {
                this.model.addPrestigePoints(Math.round(this.persistent.level * Math.pow(1.00025, this.persistent.level)));
        ...
        updateCreatureSpeed(e, t) {
            ...
            ;
            const s = 4 * this.fastDistance(e.x, e.y, e.target.x, e.target.y), i = Math.min(e.speedMultiplier * e.maxSpeed, s);
            ;
            ;
            e.position.x += e.xSpeed * t;
            e.position.y += e.ySpeed * t;
        ...
        destroyAllItems() {
            this.addXp(this.xpForItems() - this.xpForAncient() - this.xpForDivine() - this.xpForChaos());
            this.persistent.items = this.persistent.items.filter(e => e.q || (e.r == this.rarity.legendary || e.r == this.rarity.ancient || e.r == this.rarity.divine || e.r == this.rarity.chaos));
            ;
        }
        destroyAllItemsLegendary() {
            this.addXp(this.xpForLegendary());
            this.persistent.items = this.persistent.items.filter(e => e.q || (e.r == this.rarity.common || e.r == this.rarity.rare || e.r == this.rarity.epic || e.r == this.rarity.ancient || e.r == this.rarity.divine || e.r == this.rarity.chaos));
            ;
        }
        xpForItems() {
            let e = 0;
    ...
    class Ue {
        constructor() {
            if (this.creatureFactory = new ae(), this.zombies = new Ae(), this.creatures = [], this.creatureCount = [], this.aliveCreatures = [], this.aliveZombies = [], this.graveyardAttackers = [], this.discardedSprites = [], this.aliveHumans = [], this.scaling = 1.6, this.moveTargetDistance = 15, this.attackDistance = 20, this.attackSpeed = 3, this.targetDistance = 100, this.fadeSpeed = 0.1, this.currId = 1, this.scanTime = 3, this.refundChance = 0, this.creatureTypes = this.creatureFactory.types, this.golemTextures = {
                    ...
                    left: 4,
                    dead: 5
                }, this.burnTickTimer = 5, this.smokeTimer = 0.3, this.fastDistance = i, this.magnitude = t, this.damageZombie = this.zombies.damageZombie, this.searchClosestTarget = this.zombies.searchClosestTarget, this.updateBurns = this.zombies.updateBurns, this.updateZombieRegen = this.zombies.updateZombieRegen, this.causePlagueExplosion = this.zombies.causePlagueExplosion, this.inflictPlague = this.zombies.inflictPlague, this.healZombie = this.zombies.healZombie, this.setSpeedMultiplier = this.zombies.setSpeedMultiplier, Ue.instance) {
                return Ue.instance;
            }
            Ue.instance = this;
        }
        populate() {
            ...
            const e = [];
            for (let t = 0; t < this.creatures.length; t++) {
                this.model.constructions.monsterFactory ? this.creatures[t].flags.dead ? (this.discardedSprites.push(this.creatures[t]), g.removeChild(this.creatures[t])) : (e.push(this.creatures[t]), this.creatures[t].x = this.graveyard.sprite.x, this.creatures[t].zIndex = this.creatures[t].y = this.graveyard.sprite.y + (this.graveyard.level > 2 ? 8 : 0), this.creatures[t].target = null, this.creatures[t].state = be.lookingForTarget) : (this.discardedSprites.push(this.creatures[t]), g.removeChild(this.creatures[t]));
            }
            this.creatures = e;
            this.aliveCreatures = [];
        ...
        update(e) {
            ...
            for (let e = 0; e < this.creatures.length; e++) {
                this.creatures[e].visible && (this.creatures[e].flags.dead || (this.aliveZombies.push(this.creatures[e]), t++, this.creatureCount[this.creatures[e].creatureType]++, this.model.persistentData.savedCreatures.push({
        ...
        golemTaunt(e) {
            for (let t = 0; t < this.aliveHumans.length; t++) {
                Math.abs(this.aliveHumans[t].x - e.x) < this.targetDistance && Math.abs(this.aliveHumans[t].y - e.y) < this.targetDistance && (this.aliveHumans[t].vip || (this.aliveHumans[t].zombieTarget = e, this.aliveHumans[t].target = e));
            }
        }
        golemHeal(e) {
        ...
        golemFireball(e) {
            let t = 5;
            for (let s = 0; s < this.aliveHumans.length; s++) {
                t > 0 && Math.abs(this.aliveHumans[s].x - e.x) < this.targetDistance && Math.abs(this.aliveHumans[s].y - e.y) < this.targetDistance && (t--, this.bullets.newBullet(e, this.aliveHumans[s], e.attackDamage / 2, false, false, true));
            }
        }
    }
    ...
    class Oe {
        constructor() {
            if (this.spikeSprites = [], this.level = 1, this.spikeTimer = 5, this.fenceRadius = 50, this.fastDistance = i, this.graveyardHealth = 0, this.graveyardMaxHealth = 0, this.target = {
                    ...
                    x: 0,
                    y: 0
                }, this.healthBar = null, this.fence = null, this.fencePosts = [], Oe.instance) {
                return Oe.instance;
            }
            Oe.instance = this;
        }
        ...
        drawHealthBar() {
            this.gameModel.isBossStage(this.gameModel.level) ? (this.gameModel.sendMessage('Defend the Graveyard!'), this.graveyardHealth = this.graveyardMaxHealth = 100 * this.gameModel.zombieHealth * this.gameModel.graveyardHealthMod, this.healthBar || (this.healthBar = {
                ...
                percentage: 100
            }, this.healthBar.container.addChild(this.healthBar.background), this.healthBar.container.addChild(this.healthBar.foreground), b.addChild(this.healthBar.container)), this.target.x = 300, this.target.y = 300, this.healthBar.container.visible = true, this.healthBar.container.x = this.target.x - 50, this.healthBar.container.y = this.target.y - 100, this.healthBar.background.clear(), this.healthBar.background.lineStyle(12, 3355443), this.healthBar.background.moveTo(-2, 0), this.healthBar.background.lineTo(102, 0), this.healthBar.foreground.clear(), this.healthBar.foreground.lineStyle(8, 16601682), this.healthBar.foreground.moveTo(0, 0), this.healthBar.foreground.lineTo(100, 0)) : this.healthBar && (this.healthBar.background.clear(), this.healthBar.foreground.clear(), this.healthBar.container.visible = false);
        }
        updateHealthBar() {
        ...
        drawGraveyard() {
            ...
            this.fortSprite && (g.removeChild(this.fortSprite), this.fortSprite = null);
            this.level = 1;
            ;
            ...
            t && (this.fortSprite ? this.fortSprite.texture = PIXI.Texture.from(t) : this.fortSprite = new PIXI.Sprite(PIXI.Texture.from(t)), this.fortSprite.anchor.set(0.5, 1), this.fortSprite.scale.set(2, 2), this.fortSprite.x = s.x, this.fortSprite.zIndex = this.fortSprite.y = s.y + 2, this.fortSprite.visible = false, g.addChild(this.fortSprite));
            ;
        }
        drawFence() {
            ...
            ;
            const e = Math.round(0.4 * this.fenceRadius), t = 2 * Math.PI / e;
            for (let r = 0; r < e; r++) {
                let e;
                this.fencePosts[r] ? (e = this.fencePosts[r], e.visible = true) : (e = new PIXI.Sprite(a(this.fenceTextures, Math.random())), this.fencePosts.push(e), this.fence.addChild(e));
                e.anchor.set(0.5, 1);
        ...
        update(e) {
            ...
            this.gameModel.constructions.fence && this.gameModel.currentState == this.gameModel.states.playingLevel ? (this.fenceRadius !== this.gameModel.fenceRadius && this.drawFence(), this.fence.visible = true) : this.fence.visible = false;
        ...
        updatePlagueSpikes(e) {
            if (this.gameModel.constructions.plagueSpikes && (this.spikeTimer -= e, this.spikeTimer < 0)) {
                ...
                for (let t = 0; t < e.length; t++) {
                    Math.abs(e[t].x - this.sprite.x) < this.fenceRadius && Math.abs(e[t].y - this.sprite.y) < this.fenceRadius && this.fastDistance(this.sprite.x, this.sprite.y, e[t].x, e[t].y) < this.fenceRadius && (this.zombies.inflictPlague(e[t]), this.humans.damageHuman(e[t], this.gameModel.zombieDamage), this.blood.newPlagueSplatter(e[t].x, e[t].y), this.addSpikeSprite(e[t]));
                }
            }
        }
        addSpikeSprite(e) {
        ...
        updateSpikeSprites(e) {
            for (let t = 0; t < this.spikeSprites.length; t++) {
                this.spikeSprites[t].visible && (this.spikeSprites[t].alpha -= 0.4 * e, this.spikeSprites[t].alpha <= 0 && (this.spikeSprites[t].visible = false));
            }
        }
        isWithinFence(e) {
    ...
    class Ve {
        constructor() {
            if (this.sprites = [], this.maxSpeed = 125, this.scaling = 2, this.collectDistance = 10, this.fastDistance = i, Ve.instance) {
                return Ve.instance;
            }
            Ve.instance = this;
        }
        ...
        updateBoneCollector(e, t) {
            ...
            case We.collecting:
                ...
                break;
            case We.returning:
                e.target || (e.target = this.graveyard.sprite), this.fastDistance(e.position.x, e.position.y, e.target.x, e.target.y) < this.collectDistance && (e.target = false, this.gameModel.addBones(e.bones), e.bones = 0, e.state = We.collecting, e.speedFactor = 0);
            }
        }
        updateSpeed(e, t) {
            ;
    ...
    class Ke {
        constructor() {
            if (this.sprites = [], this.discardedSprites = [], this.bombSprites = [], this.discardedBombSprites = [], this.bombHeight = 100, this.scaling = 2.5, this.fastDistance = i, Ke.instance) {
                return Ke.instance;
            }
            Ke.instance = this;
        }
        populate() {
            ...
            for (let e = 0; e < this.bombSprites.length; e++) {
                this.bombSprites[e].visible && (this.bombSprites[e].visible = false, this.discardedBombSprites.push(this.bombSprites[e]));
            }
            for (let e = 0; e < this.sprites.length; e++) {
        ...
        addAndRemoveHarpies() {
            if (this.sprites.length > this.model.persistentData.harpies) {
                const e = this.sprites.pop();
                ;
                e.bomb && (e.bomb.dropped = true, e.bomb.floor = e.bomb.y + this.bombHeight);
                b.removeChild(e);
                this.discardedSprites.push(e);
                ;
            }
        ...
        updateBomb(e, t) {
            e.dropped ? (e.rotation += t * e.rotSpeed, e.ySpeed += 50 * t, e.scale.x = e.scale.y -= 0.2 * t, e.y += e.ySpeed * t, e.y >= e.floor - 2 && (e.visible = false, this.discardedBombSprites.push(e), e.fire && this.humans.burnHuman(e.target, 0.1 * this.model.zombieHealth), this.zombies.causePlagueExplosion(e, 0.2 * this.model.zombieHealth, false, false))) : (e.x = e.harpy.x, e.y = e.harpy.y);
        }
        updateHarpy(e, t) {
            switch (e.state) {
            case qe.bombing:
                ...
                this.fastDistance(e.x, e.y, e.target.x, e.target.y - this.bombHeight) < 10 ? (e.bombs--, e.bomb.dropped = true, e.bomb.floor = e.target.y, e.bomb.target = e.target, e.bomb = null, e.speedFactor = 0, e.target = false, e.bombs <= 0 ? e.state = qe.returning : this.getBomb(e)) : this.updateHarpySpeed(e, t);
                break;
            case qe.returning:
    ...
    class Je extends _ {
        ...
        updatePart(e, t, s) {
            const a = this.zmMap.normalizeVector({
                    x: s.x - e.x,
                    y: s.y - e.y
                }), r = 300 * a.x - e.xSpeed, n = 300 * a.y - e.ySpeed;
            if (e.xSpeed += r * t, e.ySpeed += n * t, e.x += e.xSpeed * t, e.y += e.ySpeed * t, i(e.x, e.y, s.x, s.y) < 30 && (e.visible = false, e.x = 100, e.y = 100, this.animElement)) {
    ...
    class _e {
        constructor() {
            if (this.maxParts = 500, this.partCounter = 0, this.partsPerSplatter = 6, this.ecoPartsPerSplatter = 3, this.container = null, this.sprites = [], this.gravity = 100, this.spraySpeed = 20, this.fadeSpeed = 0.7, this.visibleParts = 0, this.viewableArea = null, _e.instance) {
                return _e.instance;
            }
            _e.instance = this;
        }
        ...
        update(e) {
            if (this.gameModel.persistentData.particles) {
                ...
                ;
                for (let t = 0; t < this.sprites.length; t++) {
                    this.sprites[t].visible && (this.updatePart(this.sprites[t], e), this.visibleParts++);
                }
            } else {
        ...
        updatePart(e, t) {
            e.hitFloor ? (e.alpha -= this.fadeSpeed * t, e.alpha <= 0 && (e.visible = false)) : (e.ySpeed += this.gravity * t, e.x += e.xSpeed * t, e.y += e.ySpeed * t, e.y >= e.floor && (e.hitFloor = true));
        }
        newPart(e, t, s) {
    ...
    class tt {
        constructor() {
            if (this.partsLimit = 100, this.partsPerSplatter = 3, this.container = null, this.sprites = [], this.discardedSprites = [], this.uncollected = [], this.gravity = 100, this.spraySpeed = 20, this.fadeTime = 40, this.fadeSpeed = 0.2, this.fadeBones = false, this.texture = null, this.gameModel = null, tt.instance) {
                return tt.instance;
            }
            tt.instance = this;
        }
        ...
        initialize() {
            this.gameModel = ne.getInstance();
            this.container || (this.container = new PIXI.Container(), p.addChild(this.container), this.texture = this.getTexture());
            ;
            for (let e = 0; e < this.sprites.length; e++) {
        ...
        update(e) {
            const t = [];
            for (let s = 0; s < this.sprites.length; s++) {
                this.sprites[s].visible && (this.updatePart(this.sprites[s], e), t.push(this.sprites[s]));
            }
            this.uncollected = t;
        ...
        updatePart(e, t) {
            if (e.value <= 0) {
                return e.visible = false, this.discardedSprites.push(e), void this.container.removeChild(e);
            }
            e.hitFloor ? (this.fadeBones && (e.fadeTime -= t), e.fadeTime < 0 && !e.collector && (e.alpha -= this.fadeSpeed * t, e.alpha <= 0 && (e.visible = false, this.discardedSprites.push(e), this.container.removeChild(e)))) : (e.ySpeed += this.gravity * t, e.rotation += e.rotSpeed * t, e.x += e.xSpeed * t, e.y += e.ySpeed * t, e.y >= e.floor && (e.hitFloor = true));
        }
        newPart(e, t, s) {
            let i = null;
    ...
    class it {
        constructor() {
            if (this.sprites = [], this.discardedSprites = [], this.maxSprites = 10, this.height = 20, this.fadeSpeed = 4, it.instance) {
                return it.instance;
            }
            it.instance = this;
        }
    ...
    class rt {
        constructor() {
            if (this.zombies = new Ae(), this.humans = new Se(), this.graveyard = new Oe(), this.army = new Te(), this.maxParts = 20, this.speed = 150, this.hitbox = 12, this.sprites = [], this.discardedSprites = [], this.fadeSpeed = 0.2, rt.instance) {
                return rt.instance;
            }
            rt.instance = this;
        }
        ...
        updatePart(e, t) {
            i(e.x, e.y + 8, e.target.x, e.target.y) < e.hitbox ? (e.plague ? (this.zombies.inflictPlague(e.target), this.humans.damageHuman(e.target, e.damage)) : e.fireball ? (this.humans.burnHuman(e.target, e.damage), this.humans.damageHuman(e.target, e.damage)) : e.darkorb ? e.target.flags.dead || (this.humans.damageHuman(e.target, e.damage), e.target.timer.dogStun = 5, new Xe().orbHit(e.target)) : !e.rocket && e.target.bulletReflect && Math.random() < e.target.bulletReflect ? this.newBullet(e.target, e.source, e.damage, false, false, false) : e.rocket ? (e.target.graveyard && this.graveyard.damageGraveyard(e.damage), this.army.droneExplosion(e.target.x, e.target.y, null, e.damage)) : (e.target.zombie && this.zombies.damageZombie(e.target, e.damage, e.source), e.target.human && this.humans.damageHuman(e.target, e.damage)), e.visible = false, this.discardedSprites.push(e), g.removeChild(e)) : (e.x += e.xSpeed * t, e.y += e.ySpeed * t, e.zIndex = e.y);
        ...
        newBullet(e, t, s, i = false, a = false, r = false, n = false) {
            ...
            ;
            const h = t.x - o.x, l = t.y - 8 - o.y, d = Math.abs(h), c = Math.abs(l);
    ...
    class nt extends _ {
        ...
        initialize() {
            this.viewableArea = G;
            this.texture || (this.texture = this.getTexture(), this.container = new PIXI.Container(), b.addChild(this.container), this.setup(this.container, this.texture));
            ;
        }
        update(e) {
            for (let t = 0; t < this.sprites.length; t++) {
    ...
    class ot extends _ {
        constructor() {
            if (super(), this.tint = 16777215, this.viewableArea = null, this.allowTint = false, this.gameModel = null, this.sizeVariance = 0.2, ot.instance) {
                return ot.instance;
            }
            ot.instance = this;
            this.create = e => new J(e);
    ...
    class lt extends _ {
        constructor() {
            if (super(), this.partsPerSplatter = 15, this.gravity = 100, this.spraySpeed = 50, this.fadeSpeed = 0.7, this.viewableArea = G, lt.instance) {
                return lt.instance;
            }
            lt.instance = this;
        ...
        initialize() {
            this.gameModel = ne.getInstance();
            this.viewableArea = G;
            this.container || (this.container = new PIXI.Container(), p.addChild(this.container), this.texture = this.getTexture(), this.setup(this.container, this.texture));
            ;
        }
        update(e) {
            if (this.gameModel.persistentData.particles) {
        ...
        updatePart(e, t) {
            e.hitFloor ? (e.alpha -= this.fadeSpeed * t, e.alpha <= 0 && this.discardSprite(e)) : (e.ySpeed += this.gravity * t, e.x += e.xSpeed * t, e.y += e.ySpeed * t, e.y >= e.floor && (e.hitFloor = true), e.rotation += e.rotSpeed * t);
        }
        newPart(e, t, s) {
            if (!this.container.visible) {
                return;
    ...
    const dt = new Xe(), ct = new Ae(), ut = new Ue(), pt = new ae(), gt = new q();
    class xt {
    ...
    const St = [
            new xt(1, 'Efficiency', 'Golem Mastery', 12, function () {
            ...
            new xt(2, 'Thrifty', 'Golem Mastery', 12, function () {
            ...
            new xt(3, 'Fatal Bargain', 'Golem Mastery', 12, function () {
                ut.refundChance = 0;
                ct.refundChance = 0;
                ;
                const e = dt.talents[this.id];
            ...
            new xt(4, 'Recovery', 'Spell Mastery', 12, function () {
            ...
            new xt(5, 'Endurance', 'Spell Mastery', 12, function () {
                gt.timeExtension = 0;
                const e = dt.talents[this.id];
            ...
            new xt(6, 'Opportunist', 'Spell Mastery', 12, function () {
                gt.costReduction = 0;
                dt.increaseChance = 0;
                const e = dt.talents[this.id];
            ...
            new xt(7, 'Shiny', 'Skeleton Mastery', 12, function () {
                dt.lootChanceMod = 1;
                const e = dt.talents[this.id];
            ...
            new xt(8, 'Dark Orb', 'Skeleton Mastery', 10, function () {
                dt.darkorb = 0;
                const e = dt.talents[this.id];
            ...
            new xt(9, 'Bone Shield', 'Skeleton Mastery', 12, function () {
                dt.boneshield = 0;
                const e = dt.talents[this.id];
            ...
            new xt(10, 'Gigamutagen', 'Zombie Mastery', 12, function () {
                ct.gigamutagen = 0;
                const e = dt.talents[this.id];
            ...
            new xt(11, 'Blood Pact', 'Zombie Mastery', 12, function () {
                ct.bloodpact = 0;
                const e = dt.talents[this.id];
            ...
            new xt(12, 'Blood Born', 'Zombie Mastery', 12, function () {
                ct.bloodborn = 0;
                const e = dt.talents[this.id];
    ...
    function wt() {
        dt.persistent.talentReset && (St.forEach(e => e.reset()), dt.persistent.talentReset = false);
    }
    St.forEach(e => {
        if (0 == Mt.filter(t => t.name == e.group).length) {
            let t = 'blood';
            e.group == 'Golem Mastery' && (t = 'parts');
            e.group == 'Skeleton Mastery' && (t = 'bones');
            e.group == 'Spell Mastery' && (t = 'energy');
            e.group == 'Zombie Mastery' && (t = 'brains');
    ...
    angular.module('zombieApp', []).filter('decimal', function () {
        ...
        function (e, t, s) {
            ...
            function u() {
                ...
                !function (e, t) {
                    ...
                    ;
                }(Math.min(1000, Math.max(e - c.lastUpdate, 0)) / 1000, e);
                c.lastUpdate = e;
                ;
            }
            ...
            c.openSidePanel = function (e) {
                ...
                case 'shop':
                    ...
                    break;
                case 'construction':
                    c.filterConstruction(c.currentConstructionFilter), c.sidePanels.construction = true;
                    break;
                case 'graveyard':
                    c.sidePanels.graveyard = true, c.graveyardTab = 'minions', c.trophyTab = 'all';
                    break;
                case 'runesmith':
                    c.sidePanels.runesmith = true;
                    break;
                case 'factory':
                    c.sidePanels.factory = true, c.upgrades = r.generators, c.factoryStats = r.factoryStats(), c.factory.updateDelays();
                    break;
                case 'prestige':
                    c.upgrades = h.prestigeUpgrades.filter(e => 0 == e.cap || c.currentRank(e) < e.cap), c.upgrades.push(...h.prestigeUpgrades.filter(e => 0 !== e.cap && c.currentRank(e) >= e.cap)), c.upgrades = c.upgrades.filter(e => 115 !== e.id), c.sidePanels.prestige = true;
                    break;
                case 'options':
            ...
            c.factory = {
                ...
                changeFactoryTab(e) {
                    c.factoryTab = e;
                    'parts' == e ? (c.upgrades = r.generators, this.updateDelays()) : c.upgrades = o.creatures;
                    ;
                },
                buyGenerator(e) {
            ...
            c.levelSelect = {
                ...
                show() {
                    this.shown ? this.shown = false : (c.closeSidePanels(), this.shown = true, this.level = c.model.levelInfo(c.model.level), this.start = Math.floor((this.level.level - 1) / this.levelsPerPage) * this.levelsPerPage + 1, this.populate());
                },
                populate() {
                    this.levels = [];
                    this.levelRanges = [];
            ...
            c.toggleAutoStart = function () {
                c.model.persistentData.autoStart ? c.model.persistentData.autoStart = false : c.model.persistentData.autoStart = true;
            };
            c.toggleAutoStartWait = function () {
                c.model.persistentData.autoStartWait ? c.model.persistentData.autoStartWait = false : c.model.persistentData.autoStartWait = true;
            };
            c.toggleAutoSellGear = function () {
                c.model.persistentData.autoSellGear ? c.model.persistentData.autoSellGear = false : c.model.persistentData.autoSellGear = true;
            };
            c.toggleAutoSellGearLegendary = function () {
                c.model.persistentData.autoSellGearLegendary ? c.model.persistentData.autoSellGearLegendary = false : c.model.persistentData.autoSellGearLegendary = true;
            };
            ...
            c.updateMessages = function (e) {
                c.message ? (c.messageTimer -= e, c.model.messageQueue.length > 0 && (c.messageTimer -= e), c.messageTimer < 0 && (c.message = false, c.messageTimer = 4)) : c.model.messageQueue.length > 0 && (c.message = c.model.messageQueue.shift(), c.messageTimer = 4);
            };
            c.infusionAmount = 1000;
            c.infusionMax = false;
            ...
            c.skeletonMenu = {
                ...
                createGearSet() {
                    ...
                    e.length > 0 ? newGearSet.slots.push({
                        s: e[0].s,
                        id: e[0].id
                    ...
                    s.length > 0 ? newGearSet.slots.push({
                        s: s[0].s,
                        id: s[0].id
                    }) : newGearSet.slots.push({
                    ...
                    a.length > 0 ? newGearSet.slots.push({
                        s: a[0].s,
                        id: a[0].id
                    }) : newGearSet.slots.push({
                    ...
                    r.length > 0 ? newGearSet.slots.push({
                        s: r[0].s,
                        id: r[0].id
                    }) : newGearSet.slots.push({
                    ...
                    o.length > 0 ? newGearSet.slots.push({
                        s: o[0].s,
                        id: o[0].id
                    }) : newGearSet.slots.push({
                    ...
                    h.length > 0 ? newGearSet.slots.push({
                        s: h[0].s,
                        id: h[0].id
                    }) : newGearSet.slots.push({
                    ...
                    l.length > 0 ? newGearSet.slots.push({
                        s: l[0].s,
                        id: l[0].id
                    }) : newGearSet.slots.push({
                ...
                anotherOffer: () => i.persistent.skeletons > 0 && c.model.persistentData.trophies.length >= (i.persistent.xpRate < 4 ? 20 * i.persistent.xpRate : i.persistent.xpRate < 8 ? 70 : i.persistent.xpRate < 16 ? 110 : i.persistent.xpRate < 32 ? 160 : i.persistent.xpRate < 64 ? 220 : i.persistent.xpRate < 128 ? 290 : i.persistent.xpRate < 256 ? 370 : i.persistent.xpRate < 512 ? 460 : i.persistent.xpRate < 1024 ? 560 : i.persistent.xpRate < 2048 ? 670 : i.persistent.xpRate < 4096 ? 790 : 720 + (Math.log2(i.persistent.xpRate) - 7) * (Math.log2(i.persistent.xpRate) - 7) * 10),
                trophies: () => i.persistent.skeletons > 0 ? ` - ${ c.model.persistentData.trophies.length } / ${ i.persistent.xpRate < 4 ? 20 * i.persistent.xpRate : i.persistent.xpRate < 8 ? 70 : i.persistent.xpRate < 16 ? 110 : i.persistent.xpRate < 32 ? 160 : i.persistent.xpRate < 64 ? 220 : i.persistent.xpRate < 128 ? 290 : i.persistent.xpRate < 256 ? 370 : i.persistent.xpRate < 512 ? 460 : i.persistent.xpRate < 1024 ? 560 : i.persistent.xpRate < 2048 ? 670 : i.persistent.xpRate < 4096 ? 790 : 720 + (Math.log2(i.persistent.xpRate) - 7) * (Math.log2(i.persistent.xpRate) - 7) * 10 } Trophies` : '',
                ...
                updateEquippedItems() {
                    ...
                    const t = [], s = i.persistent.items.filter(e => e.q && e.s == i.lootPositions.sword.id);
                    ...
                    ;
                    const n = [], o = i.persistent.items.filter(e => e.q && e.s == i.lootPositions.gloves.id);
                ...
                itemDropped(e, t) {
                    ...
                    -1 == t ? i.destroyItem(s) : (s.s == t && (i.persistent.items.forEach(function (e) {
                        e.s == t && (e.q = false);
                    }), s.q = true, h.applyUpgrades()), this.updateEquippedItems());
                    ;
                ...
                trashAll() {
                    c.confirmMessage = 'Are you sure you want to destroy all non-equipped items? You will earn ' + n(i.xpTotal()) + ' xp';
                    c.confirmCallback = function () {
                        c.confirmCallback = false;
                        i.destroyAllItems();
                        ;
        ...
        return { templateUrl: './templates/levelselect.html' };
    }).directive('levelStats', function () {
        return { templateUrl: './templates/levelstats.html' };
    }).directive('graveyardMenu', function () {
        return { templateUrl: './templates/graveyardmenu.html' };
    }).directive('runesmithMenu', function () {
        return { templateUrl: './templates/runesmithmenu.html' };
    }).directive('optionsMenu', function () {
        return { templateUrl: './templates/optionsmenu.html' };
    }).directive('shopMenu', function () {
        return { templateUrl: './templates/shopmenu.html' };
    }).directive('constructionMenu', function () {
        return { templateUrl: './templates/constructionmenu.html' };
    }).directive('prestigeMenu', function () {
        return { templateUrl: './templates/prestigemenu.html' };
    }).directive('championsHoldMenu', function () {
        return { templateUrl: './templates/championshold.html' };
    }).directive('factoryMenu', function () {
        return { templateUrl: './templates/factorymenu.html' };
            ...
            return {
                ...
                link: function (t, s, i, a) {
                    ...
                    s.bind('dragover', function (e) {
                        return e.preventDefault && e.preventDefault(), e.dataTransfer.dropEffect = 'move', false;
                    });
                    ...
                    s.bind('drop', function (e) {
                        ...
                        ;
                        const s = e.dataTransfer.getData('text'), i = t.zm.skeletonMenu.itemById(s);
                        if (i) {
