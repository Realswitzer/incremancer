...
(() => {
        ...
        (this.spells = [
          ...
          new W(
            ...
            function () {
              ...
              if (
                ne.getInstance().persistentData.autoMaxHarpies &&
                ne.getInstance().constructions.aviary
              ) {
  ...
  class ne {
    ...
    update(e, t) {
      ...
      if (
        this.persistentData.autoStartWait == !1 &&
  ...
  class Xe {
    ...
    update(e) {
      ...
      if (
        this.model.persistentData.autoSellGear == !0 &&
        this.aliveSkeletons.length > 0
      ) {
        this.destroyAllItems();
      }
      if (
        this.model.persistentData.autoSellGearLegendary == !0 &&
        this.aliveSkeletons.length > 0
      ) {
          ...
          (c.model = ne.getInstance()),
            ...
            (c.toggleAutoStartWait = function () {
              c.model.persistentData.autoStartWait
                ? (c.model.persistentData.autoStartWait = !1)
                : (c.model.persistentData.autoStartWait = !0);
            }),
            (c.toggleAutoSellGear = function () {
              c.model.persistentData.autoSellGear
                ? (c.model.persistentData.autoSellGear = !1)
                : (c.model.persistentData.autoSellGear = !0);
            }),
            (c.toggleAutoSellGearLegendary = function () {
              c.model.persistentData.autoSellGearLegendary
                ? (c.model.persistentData.autoSellGearLegendary = !1)
                : (c.model.persistentData.autoSellGearLegendary = !0);
            }),
