...
>
  ...
  >
  <p class="prestige-info">
    You currently have <strong>{whole(model.persistentData.prestigePointsToSpend)}</strong> prestige
    points to spend
  </p>
  <div class="upgrades">
    <div
    ...
    >
      ...
      <button
        ...
        class="info {upgrade.selected ? 'active' : ''}">Info</button
      >
      <p ng-show="upgrade.selected">{upgrade.description}</p>
      <p ng-show="upgrade.selected">
