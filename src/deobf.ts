...
function U(e, t) {
  ...
  (function (e, t) {
    if (
      ...
      c.position.set(0, 0),
        humans.vip &&
          ((X.tx = -2 * humans.vip.x + 150), (X.ty = -2 * humans.vip.y + 150)),
        c.scale.set(2, 2),
...
class CreatureFactory {
  constructor() {
    ...
    // TODO: May be able to replace with a TS enum
    this.types = {
      earthGolem: 1,
      airGolem: 2,
      fireGolem: 3,
  ...
  updateAutoBuild() {
    for (let e = 0; e < this.creatures.length; e++) {
      this.creatures[e].autobuild =
        this.gameModel.persistentData.creatureAutobuild[this.creatures[e].id] ||
        0;
    }
  }
  resetLevels() {
...
// Technically, should probably be `Creature`, but only creatures are golems.
class Golem {
  id: number;
  /** TODO: {@link CreatureFactory.types} Enum*/
  type: number;
  name: string;
  baseHealth: number;
  baseDamage: number;
...
class GameModel {
  ...
  calcOfflineProgress() {
    ...
    if (this.constructions.partFactory) {
      const e = (Date.now() - this.persistentData.dateOfSave) / 1000; /* 1e3 */
  ...
  levelLocked(e) {
    return (
      e > this.persistentData.allTimeHighestLevel + 1 || !this.bossCompleted(e)
    );
  }
  isBossStage(e) {
    return e > 0 && e % 50 == 0;
  ...
  applyUpgrade(e, t) {
    switch (e.type) {
      ...
      case this.types.graveyardHealth: {
        return void (this.gameModel.graveyardHealthMod *= (1 + e.effect) ** t);
      }
  ...
  displayStatValue(e) {
    switch (e.type) {
      ...
      case this.types.startingPC: {
        ...
        )} brains, ${Math.round(200 * this.gameModel.startingResources)} bones`;
      }
      case this.types.unlockSpell: {
      ...
      if (this.gameModel.persistentData.currentConstruction) {
        ...
        if (this.constructionTickTimer < 0) {
          ...
          if (
            ...
            if (
              this.gameModel.persistentData.currentConstruction.timeRemaining <=
              0
            ) {
...
class Police {
  ...
  radioForBackup(e) {
    ...
    for (let a = 0; a < this.police.length; a++) {
      if (
        ...
        (!this.police[a].zombieTarget || this.police[a].zombieTarget.flags.dead)
      ) {
  ...
  updatePolice(e, t, s) {
    ...
    switch (e.policeState) {
      ...
      case policeState.walking: {
        if (
          fastDistance(e.position.x, e.position.y, e.target.x, e.target.y) <
          this.moveTargetDistance
        ) {
          e.target = false;
          e.zombieTarget = null;
  ...
  damageZombie(e, t, s) {
    if (e.graveyard) {
      ...
      if (s && this.model.runeEffects.damageReflection > 0) {
        this.humans.damageHuman(s, t * this.model.runeEffects.damageReflection);
      }
    }
  }
...
class Bullets {
  ...
  updatePart(e, t) {
    if (fastDistance(e.x, e.y + 8, e.target.x, e.target.y) < e.hitbox) {
      if (e.plague) {
